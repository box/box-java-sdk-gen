...
public class BoxClient {
  ...
  public BoxClient(Authentication auth) {
    this.auth = auth;
    this.networkSession = new NetworkSession.NetworkSessionBuilder().baseUrls(new BaseUrls()).build();
    this.authorization = new AuthorizationManager.AuthorizationManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.files = new FilesManager.FilesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.trashedFiles = new TrashedFilesManager.TrashedFilesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.appItemAssociations = new AppItemAssociationsManager.AppItemAssociationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.downloads = new DownloadsManager.DownloadsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.uploads = new UploadsManager.UploadsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.chunkedUploads = new ChunkedUploadsManager.ChunkedUploadsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.listCollaborations = new ListCollaborationsManager.ListCollaborationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.comments = new CommentsManager.CommentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.tasks = new TasksManager.TasksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileVersions = new FileVersionsManager.FileVersionsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileMetadata = new FileMetadataManager.FileMetadataManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileClassifications = new FileClassificationsManager.FileClassificationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.skills = new SkillsManager.SkillsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileWatermarks = new FileWatermarksManager.FileWatermarksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileRequests = new FileRequestsManager.FileRequestsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.folders = new FoldersManager.FoldersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.trashedFolders = new TrashedFoldersManager.TrashedFoldersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.folderMetadata = new FolderMetadataManager.FolderMetadataManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.folderClassifications = new FolderClassificationsManager.FolderClassificationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.trashedItems = new TrashedItemsManager.TrashedItemsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.folderWatermarks = new FolderWatermarksManager.FolderWatermarksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.folderLocks = new FolderLocksManager.FolderLocksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.metadataTemplates = new MetadataTemplatesManager.MetadataTemplatesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.classifications = new ClassificationsManager.ClassificationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.metadataCascadePolicies = new MetadataCascadePoliciesManager.MetadataCascadePoliciesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.search = new SearchManager.SearchManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.userCollaborations = new UserCollaborationsManager.UserCollaborationsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.taskAssignments = new TaskAssignmentsManager.TaskAssignmentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.sharedLinksFiles = new SharedLinksFilesManager.SharedLinksFilesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.sharedLinksFolders = new SharedLinksFoldersManager.SharedLinksFoldersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.webLinks = new WebLinksManager.WebLinksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.trashedWebLinks = new TrashedWebLinksManager.TrashedWebLinksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.sharedLinksWebLinks = new SharedLinksWebLinksManager.SharedLinksWebLinksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.users = new UsersManager.UsersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.sessionTermination = new SessionTerminationManager.SessionTerminationManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.avatars = new AvatarsManager.AvatarsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.transfer = new TransferManager.TransferManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.emailAliases = new EmailAliasesManager.EmailAliasesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.memberships = new MembershipsManager.MembershipsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.invites = new InvitesManager.InvitesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.groups = new GroupsManager.GroupsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.webhooks = new WebhooksManager.WebhooksManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.events = new EventsManager.EventsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.collections = new CollectionsManager.CollectionsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.recentItems = new RecentItemsManager.RecentItemsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.retentionPolicies = new RetentionPoliciesManager.RetentionPoliciesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.retentionPolicyAssignments = new RetentionPolicyAssignmentsManager.RetentionPolicyAssignmentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.legalHoldPolicies = new LegalHoldPoliciesManager.LegalHoldPoliciesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.legalHoldPolicyAssignments = new LegalHoldPolicyAssignmentsManager.LegalHoldPolicyAssignmentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileVersionRetentions = new FileVersionRetentionsManager.FileVersionRetentionsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.fileVersionLegalHolds = new FileVersionLegalHoldsManager.FileVersionLegalHoldsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.shieldInformationBarriers = new ShieldInformationBarriersManager.ShieldInformationBarriersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.shieldInformationBarrierReports = new ShieldInformationBarrierReportsManager.ShieldInformationBarrierReportsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.shieldInformationBarrierSegments = new ShieldInformationBarrierSegmentsManager.ShieldInformationBarrierSegmentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.shieldInformationBarrierSegmentMembers = new ShieldInformationBarrierSegmentMembersManager.ShieldInformationBarrierSegmentMembersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.shieldInformationBarrierSegmentRestrictions = new ShieldInformationBarrierSegmentRestrictionsManager.ShieldInformationBarrierSegmentRestrictionsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.devicePinners = new DevicePinnersManager.DevicePinnersManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.termsOfServices = new TermsOfServicesManager.TermsOfServicesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.termsOfServiceUserStatuses = new TermsOfServiceUserStatusesManager.TermsOfServiceUserStatusesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.collaborationAllowlistEntries = new CollaborationAllowlistEntriesManager.CollaborationAllowlistEntriesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.collaborationAllowlistExemptTargets = new CollaborationAllowlistExemptTargetsManager.CollaborationAllowlistExemptTargetsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.storagePolicies = new StoragePoliciesManager.StoragePoliciesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.storagePolicyAssignments = new StoragePolicyAssignmentsManager.StoragePolicyAssignmentsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.zipDownloads = new ZipDownloadsManager.ZipDownloadsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.signRequests = new SignRequestsManager.SignRequestsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.workflows = new WorkflowsManager.WorkflowsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.signTemplates = new SignTemplatesManager.SignTemplatesManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.integrationMappings = new IntegrationMappingsManager.IntegrationMappingsManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
    this.ai = new AiManager.AiManagerBuilder().auth(this.auth).networkSession(this.networkSession).build();
  }
  ...
  protected BoxClient(BoxClientBuilder builder) {
    ...
    this.shieldInformationBarrierSegmentRestrictions = builder.shieldInformationBarrierSegmentRestrictions;
  ...
  public BoxClient withAsUserHeader(String userId) {
    return new BoxClient.BoxClientBuilder(this.auth).networkSession(this.networkSession.withAdditionalHeaders(mapOf(entryOf("As-User", userId)))).build();
  }

  public BoxClient withSuppressedNotifications() {
    return new BoxClient.BoxClientBuilder(this.auth).networkSession(this.networkSession.withAdditionalHeaders(mapOf(entryOf("Box-Notifications", "off")))).build();
  }
  ...
  public BoxClient withExtraHeaders(Map<String, String> extraHeaders) {
    return new BoxClient.BoxClientBuilder(this.auth).networkSession(this.networkSession.withAdditionalHeaders(extraHeaders)).build();
  }

  public BoxClient withCustomBaseUrls(BaseUrls baseUrls) {
    return new BoxClient.BoxClientBuilder(this.auth).networkSession(this.networkSession.withCustomBaseUrls(baseUrls)).build();
  }
  ...
  public static class BoxClientBuilder {
    ...
    protected ShieldInformationBarrierSegmentRestrictionsManager shieldInformationBarrierSegmentRestrictions;
    ...
    public BoxClientBuilder folderClassifications(FolderClassificationsManager folderClassifications) {
    ...
    public BoxClientBuilder metadataCascadePolicies(MetadataCascadePoliciesManager metadataCascadePolicies) {
    ...
    public BoxClientBuilder retentionPolicyAssignments(RetentionPolicyAssignmentsManager retentionPolicyAssignments) {
    ...
    public BoxClientBuilder legalHoldPolicyAssignments(LegalHoldPolicyAssignmentsManager legalHoldPolicyAssignments) {
      this.legalHoldPolicyAssignments = legalHoldPolicyAssignments;
      return this;
    }

    public BoxClientBuilder fileVersionRetentions(FileVersionRetentionsManager fileVersionRetentions) {
      this.fileVersionRetentions = fileVersionRetentions;
      return this;
    }

    public BoxClientBuilder fileVersionLegalHolds(FileVersionLegalHoldsManager fileVersionLegalHolds) {
      this.fileVersionLegalHolds = fileVersionLegalHolds;
      return this;
    }

    public BoxClientBuilder shieldInformationBarriers(ShieldInformationBarriersManager shieldInformationBarriers) {
      this.shieldInformationBarriers = shieldInformationBarriers;
      return this;
    }

    public BoxClientBuilder shieldInformationBarrierReports(ShieldInformationBarrierReportsManager shieldInformationBarrierReports) {
      this.shieldInformationBarrierReports = shieldInformationBarrierReports;
      return this;
    }

    public BoxClientBuilder shieldInformationBarrierSegments(ShieldInformationBarrierSegmentsManager shieldInformationBarrierSegments) {
      this.shieldInformationBarrierSegments = shieldInformationBarrierSegments;
      return this;
    }

    public BoxClientBuilder shieldInformationBarrierSegmentMembers(ShieldInformationBarrierSegmentMembersManager shieldInformationBarrierSegmentMembers) {
      this.shieldInformationBarrierSegmentMembers = shieldInformationBarrierSegmentMembers;
      return this;
    }

    public BoxClientBuilder shieldInformationBarrierSegmentRestrictions(ShieldInformationBarrierSegmentRestrictionsManager shieldInformationBarrierSegmentRestrictions) {
      this.shieldInformationBarrierSegmentRestrictions = shieldInformationBarrierSegmentRestrictions;
      return this;
    }
    ...
    public BoxClientBuilder termsOfServiceUserStatuses(TermsOfServiceUserStatusesManager termsOfServiceUserStatuses) {
      this.termsOfServiceUserStatuses = termsOfServiceUserStatuses;
      return this;
    }

    public BoxClientBuilder collaborationAllowlistEntries(CollaborationAllowlistEntriesManager collaborationAllowlistEntries) {
      this.collaborationAllowlistEntries = collaborationAllowlistEntries;
      return this;
    }

    public BoxClientBuilder collaborationAllowlistExemptTargets(CollaborationAllowlistExemptTargetsManager collaborationAllowlistExemptTargets) {
    ...
    public BoxClientBuilder storagePolicyAssignments(StoragePolicyAssignmentsManager storagePolicyAssignments) {
