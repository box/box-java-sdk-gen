...
public class CreateRetentionPolicyAssignmentHeaders {
  ...
  protected CreateRetentionPolicyAssignmentHeaders(CreateRetentionPolicyAssignmentHeadersBuilder builder) {
  ...
  public static class CreateRetentionPolicyAssignmentHeadersBuilder {
    ...
    public CreateRetentionPolicyAssignmentHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
