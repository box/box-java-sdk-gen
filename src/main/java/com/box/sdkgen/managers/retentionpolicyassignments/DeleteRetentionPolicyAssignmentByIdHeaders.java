...
public class DeleteRetentionPolicyAssignmentByIdHeaders {
  ...
  protected DeleteRetentionPolicyAssignmentByIdHeaders(DeleteRetentionPolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class DeleteRetentionPolicyAssignmentByIdHeadersBuilder {
    ...
    public DeleteRetentionPolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
