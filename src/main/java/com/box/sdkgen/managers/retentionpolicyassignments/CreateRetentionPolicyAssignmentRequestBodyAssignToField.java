...
public class CreateRetentionPolicyAssignmentRequestBodyAssignToField {
  ...
  public CreateRetentionPolicyAssignmentRequestBodyAssignToField(@JsonProperty("type") EnumWrapper<CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField> type) {
    this.type = type;
  }
  ...
  public CreateRetentionPolicyAssignmentRequestBodyAssignToField(CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField type) {
    this.type = new EnumWrapper<CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField>(type.getValue(), type);
  }

  protected CreateRetentionPolicyAssignmentRequestBodyAssignToField(CreateRetentionPolicyAssignmentRequestBodyAssignToFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRetentionPolicyAssignmentRequestBodyAssignToField casted = (CreateRetentionPolicyAssignmentRequestBodyAssignToField) o;
  ...
  public String toString() {
    return "CreateRetentionPolicyAssignmentRequestBodyAssignToField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class CreateRetentionPolicyAssignmentRequestBodyAssignToFieldBuilder {
    ...
    public CreateRetentionPolicyAssignmentRequestBodyAssignToFieldBuilder(CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField type) {
      this.type = new EnumWrapper<CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField>(type.getValue(), type);
    }
