...
public class GetRetentionPolicyAssignmentsHeaders {
  ...
  protected GetRetentionPolicyAssignmentsHeaders(GetRetentionPolicyAssignmentsHeadersBuilder builder) {
  ...
  public static class GetRetentionPolicyAssignmentsHeadersBuilder {
    ...
    public GetRetentionPolicyAssignmentsHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
