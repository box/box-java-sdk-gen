...
public class GetRetentionPolicyAssignmentByIdHeaders {
  ...
  protected GetRetentionPolicyAssignmentByIdHeaders(GetRetentionPolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class GetRetentionPolicyAssignmentByIdHeadersBuilder {
    ...
    public GetRetentionPolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
