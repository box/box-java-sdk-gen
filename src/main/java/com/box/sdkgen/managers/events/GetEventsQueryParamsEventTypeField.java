...
public enum GetEventsQueryParamsEventTypeField {
  ...
  GetEventsQueryParamsEventTypeField(String value) {
    this.value = value;
  }
  ...
  public static class GetEventsQueryParamsEventTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<GetEventsQueryParamsEventTypeField>> {

    public GetEventsQueryParamsEventTypeFieldDeserializer() {
      super();
    }

    @Override
    public EnumWrapper<GetEventsQueryParamsEventTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(GetEventsQueryParamsEventTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<GetEventsQueryParamsEventTypeField>(value, v)).orElse(new EnumWrapper<GetEventsQueryParamsEventTypeField>(value));
    }

  }

  public static class GetEventsQueryParamsEventTypeFieldSerializer extends JsonSerializer<EnumWrapper<GetEventsQueryParamsEventTypeField>> {

    public GetEventsQueryParamsEventTypeFieldSerializer() {
      super();
    }

    @Override
    public void serialize(EnumWrapper<GetEventsQueryParamsEventTypeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
