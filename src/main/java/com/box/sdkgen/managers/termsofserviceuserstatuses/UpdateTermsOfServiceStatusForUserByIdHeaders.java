...
public class UpdateTermsOfServiceStatusForUserByIdHeaders {
  ...
  protected UpdateTermsOfServiceStatusForUserByIdHeaders(UpdateTermsOfServiceStatusForUserByIdHeadersBuilder builder) {
  ...
  public static class UpdateTermsOfServiceStatusForUserByIdHeadersBuilder {
    ...
    public UpdateTermsOfServiceStatusForUserByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
