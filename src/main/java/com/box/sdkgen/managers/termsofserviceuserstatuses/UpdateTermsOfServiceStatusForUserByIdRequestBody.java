...
public class UpdateTermsOfServiceStatusForUserByIdRequestBody {
  ...
  public UpdateTermsOfServiceStatusForUserByIdRequestBody(@JsonProperty("is_accepted") boolean isAccepted) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTermsOfServiceStatusForUserByIdRequestBody casted = (UpdateTermsOfServiceStatusForUserByIdRequestBody) o;
  ...
  public String toString() {
    return "UpdateTermsOfServiceStatusForUserByIdRequestBody{" + "isAccepted='" + isAccepted + '\'' + "}";
  }
