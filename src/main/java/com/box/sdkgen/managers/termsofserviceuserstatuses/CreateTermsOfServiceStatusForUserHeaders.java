...
public class CreateTermsOfServiceStatusForUserHeaders {
  ...
  protected CreateTermsOfServiceStatusForUserHeaders(CreateTermsOfServiceStatusForUserHeadersBuilder builder) {
  ...
  public static class CreateTermsOfServiceStatusForUserHeadersBuilder {
    ...
    public CreateTermsOfServiceStatusForUserHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
