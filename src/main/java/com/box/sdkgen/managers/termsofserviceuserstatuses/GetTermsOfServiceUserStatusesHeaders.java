...
public class GetTermsOfServiceUserStatusesHeaders {
  ...
  protected GetTermsOfServiceUserStatusesHeaders(GetTermsOfServiceUserStatusesHeadersBuilder builder) {
  ...
  public static class GetTermsOfServiceUserStatusesHeadersBuilder {
    ...
    public GetTermsOfServiceUserStatusesHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
