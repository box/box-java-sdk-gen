...
public class UpdateFileMetadataByIdRequestBody {
  ...
  public String toString() {
    return "UpdateFileMetadataByIdRequestBody{" + "op='" + op + '\'' + ", " + "path='" + path + '\'' + ", " + "value='" + value + '\'' + ", " + "from='" + from + '\'' + "}";
  }
  ...
  public static class UpdateFileMetadataByIdRequestBodyBuilder {
    ...
    public UpdateFileMetadataByIdRequestBodyBuilder op(UpdateFileMetadataByIdRequestBodyOpField op) {
