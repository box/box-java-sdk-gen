...
public class CreateShieldInformationBarrierSegmentHeaders {
  ...
  protected CreateShieldInformationBarrierSegmentHeaders(CreateShieldInformationBarrierSegmentHeadersBuilder builder) {
  ...
  public static class CreateShieldInformationBarrierSegmentHeadersBuilder {
    ...
    public CreateShieldInformationBarrierSegmentHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
