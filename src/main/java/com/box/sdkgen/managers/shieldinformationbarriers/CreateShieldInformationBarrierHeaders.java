...
public class CreateShieldInformationBarrierHeaders {
  ...
  protected CreateShieldInformationBarrierHeaders(CreateShieldInformationBarrierHeadersBuilder builder) {
  ...
  public static class CreateShieldInformationBarrierHeadersBuilder {
    ...
    public CreateShieldInformationBarrierHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
