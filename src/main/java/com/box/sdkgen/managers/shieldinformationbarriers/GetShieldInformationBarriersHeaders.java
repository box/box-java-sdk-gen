...
public class GetShieldInformationBarriersHeaders {
  ...
  protected GetShieldInformationBarriersHeaders(GetShieldInformationBarriersHeadersBuilder builder) {
  ...
  public static class GetShieldInformationBarriersHeadersBuilder {
    ...
    public GetShieldInformationBarriersHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
