...
public class GetShieldInformationBarrierByIdHeaders {
  ...
  protected GetShieldInformationBarrierByIdHeaders(GetShieldInformationBarrierByIdHeadersBuilder builder) {
  ...
  public static class GetShieldInformationBarrierByIdHeadersBuilder {
    ...
    public GetShieldInformationBarrierByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
