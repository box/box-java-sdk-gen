...
public class AddClassificationRequestBodyDataStaticConfigClassificationField {
  ...
  protected AddClassificationRequestBodyDataStaticConfigClassificationField(AddClassificationRequestBodyDataStaticConfigClassificationFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    AddClassificationRequestBodyDataStaticConfigClassificationField casted = (AddClassificationRequestBodyDataStaticConfigClassificationField) o;
  ...
  public String toString() {
    return "AddClassificationRequestBodyDataStaticConfigClassificationField{" + "classificationDefinition='" + classificationDefinition + '\'' + ", " + "colorId='" + colorId + '\'' + "}";
  }
  ...
  public static class AddClassificationRequestBodyDataStaticConfigClassificationFieldBuilder {
    ...
    public AddClassificationRequestBodyDataStaticConfigClassificationFieldBuilder classificationDefinition(String classificationDefinition) {
      this.classificationDefinition = classificationDefinition;
      return this;
    }

    public AddClassificationRequestBodyDataStaticConfigClassificationFieldBuilder colorId(Long colorId) {
