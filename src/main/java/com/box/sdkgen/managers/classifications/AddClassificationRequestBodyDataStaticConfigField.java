...
public class AddClassificationRequestBodyDataStaticConfigField {
  ...
  protected AddClassificationRequestBodyDataStaticConfigField(AddClassificationRequestBodyDataStaticConfigFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    AddClassificationRequestBodyDataStaticConfigField casted = (AddClassificationRequestBodyDataStaticConfigField) o;
  ...
  public String toString() {
    return "AddClassificationRequestBodyDataStaticConfigField{" + "classification='" + classification + '\'' + "}";
  }
  ...
  public static class AddClassificationRequestBodyDataStaticConfigFieldBuilder {
    ...
    public AddClassificationRequestBodyDataStaticConfigFieldBuilder classification(AddClassificationRequestBodyDataStaticConfigClassificationField classification) {
