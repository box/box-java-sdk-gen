...
public class CreateClassificationTemplateHeaders {
  ...
  protected CreateClassificationTemplateHeaders(CreateClassificationTemplateHeadersBuilder builder) {
  ...
  public static class CreateClassificationTemplateHeadersBuilder {
    ...
    public CreateClassificationTemplateHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
