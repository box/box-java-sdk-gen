...
public class CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField {
  ...
  protected CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField(CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField casted = (CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField) o;
  ...
  public String toString() {
    return "CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField{" + "classification='" + classification + '\'' + "}";
  }
  ...
  public static class CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigFieldBuilder {
    ...
    public CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigFieldBuilder classification(CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField classification) {
