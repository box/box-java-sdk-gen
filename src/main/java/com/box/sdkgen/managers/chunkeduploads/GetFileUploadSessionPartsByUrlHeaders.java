...
public class GetFileUploadSessionPartsByUrlHeaders {
  ...
  protected GetFileUploadSessionPartsByUrlHeaders(GetFileUploadSessionPartsByUrlHeadersBuilder builder) {
  ...
  public static class GetFileUploadSessionPartsByUrlHeadersBuilder {
    ...
    public GetFileUploadSessionPartsByUrlHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
