...
public class CreateFileUploadSessionForExistingFileHeaders {
  ...
  protected CreateFileUploadSessionForExistingFileHeaders(CreateFileUploadSessionForExistingFileHeadersBuilder builder) {
  ...
  public static class CreateFileUploadSessionForExistingFileHeadersBuilder {
    ...
    public CreateFileUploadSessionForExistingFileHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
