...
public class CreateDocgenTemplateV2025R0Headers {
  ...
  public CreateDocgenTemplateV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected CreateDocgenTemplateV2025R0Headers(CreateDocgenTemplateV2025R0HeadersBuilder builder) {
  ...
  public static class CreateDocgenTemplateV2025R0HeadersBuilder {

    protected EnumWrapper<BoxVersionHeaderV2025R0> boxVersion;

    protected Map<String, String> extraHeaders;

    public CreateDocgenTemplateV2025R0HeadersBuilder() {
      this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
      this.extraHeaders = mapOf();
    }

    public CreateDocgenTemplateV2025R0HeadersBuilder boxVersion(
    ...
    public CreateDocgenTemplateV2025R0HeadersBuilder extraHeaders(
        Map<String, String> extraHeaders) {
      this.extraHeaders = extraHeaders;
      return this;
    }

    public CreateDocgenTemplateV2025R0Headers build() {
      return new CreateDocgenTemplateV2025R0Headers(this);
    }
  }
}
