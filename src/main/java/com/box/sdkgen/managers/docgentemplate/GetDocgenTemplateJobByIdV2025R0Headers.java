...
public class GetDocgenTemplateJobByIdV2025R0Headers {
  ...
  public GetDocgenTemplateJobByIdV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected GetDocgenTemplateJobByIdV2025R0Headers(
      GetDocgenTemplateJobByIdV2025R0HeadersBuilder builder) {
  ...
  public static class GetDocgenTemplateJobByIdV2025R0HeadersBuilder {

    protected EnumWrapper<BoxVersionHeaderV2025R0> boxVersion;

    protected Map<String, String> extraHeaders;

    public GetDocgenTemplateJobByIdV2025R0HeadersBuilder() {
      this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
      this.extraHeaders = mapOf();
    }

    public GetDocgenTemplateJobByIdV2025R0HeadersBuilder boxVersion(
    ...
    public GetDocgenTemplateJobByIdV2025R0HeadersBuilder extraHeaders(
        Map<String, String> extraHeaders) {
      this.extraHeaders = extraHeaders;
      return this;
    }

    public GetDocgenTemplateJobByIdV2025R0Headers build() {
      return new GetDocgenTemplateJobByIdV2025R0Headers(this);
    }
  }
}
