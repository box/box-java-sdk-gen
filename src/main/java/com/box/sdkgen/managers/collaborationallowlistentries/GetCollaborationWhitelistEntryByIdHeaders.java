...
public class GetCollaborationWhitelistEntryByIdHeaders {
  ...
  protected GetCollaborationWhitelistEntryByIdHeaders(GetCollaborationWhitelistEntryByIdHeadersBuilder builder) {
  ...
  public static class GetCollaborationWhitelistEntryByIdHeadersBuilder {
    ...
    public GetCollaborationWhitelistEntryByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
