...
public class CreateCollaborationWhitelistEntryHeaders {
  ...
  protected CreateCollaborationWhitelistEntryHeaders(CreateCollaborationWhitelistEntryHeadersBuilder builder) {
  ...
  public static class CreateCollaborationWhitelistEntryHeadersBuilder {
    ...
    public CreateCollaborationWhitelistEntryHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
