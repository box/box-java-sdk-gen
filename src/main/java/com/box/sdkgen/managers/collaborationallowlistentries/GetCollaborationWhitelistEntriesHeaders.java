...
public class GetCollaborationWhitelistEntriesHeaders {
  ...
  protected GetCollaborationWhitelistEntriesHeaders(GetCollaborationWhitelistEntriesHeadersBuilder builder) {
  ...
  public static class GetCollaborationWhitelistEntriesHeadersBuilder {
    ...
    public GetCollaborationWhitelistEntriesHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
