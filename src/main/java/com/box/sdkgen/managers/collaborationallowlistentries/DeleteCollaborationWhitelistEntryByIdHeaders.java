...
public class DeleteCollaborationWhitelistEntryByIdHeaders {
  ...
  protected DeleteCollaborationWhitelistEntryByIdHeaders(DeleteCollaborationWhitelistEntryByIdHeadersBuilder builder) {
  ...
  public static class DeleteCollaborationWhitelistEntryByIdHeadersBuilder {
    ...
    public DeleteCollaborationWhitelistEntryByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
