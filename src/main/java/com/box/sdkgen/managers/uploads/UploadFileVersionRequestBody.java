...
public class UploadFileVersionRequestBody {
  ...
  public UploadFileVersionRequestBody(UploadFileVersionRequestBodyAttributesField attributes, ByteStream file) {
  ...
  public static class UploadFileVersionRequestBodyBuilder {
    ...
    public UploadFileVersionRequestBodyBuilder(UploadFileVersionRequestBodyAttributesField attributes, ByteStream file) {
      this.attributes = attributes;
      this.file = file;
    }
