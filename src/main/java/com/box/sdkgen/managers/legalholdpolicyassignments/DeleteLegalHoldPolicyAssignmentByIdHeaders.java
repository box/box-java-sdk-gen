...
public class DeleteLegalHoldPolicyAssignmentByIdHeaders {
  ...
  protected DeleteLegalHoldPolicyAssignmentByIdHeaders(DeleteLegalHoldPolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class DeleteLegalHoldPolicyAssignmentByIdHeadersBuilder {
    ...
    public DeleteLegalHoldPolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
