...
public class CreateLegalHoldPolicyAssignmentHeaders {
  ...
  protected CreateLegalHoldPolicyAssignmentHeaders(CreateLegalHoldPolicyAssignmentHeadersBuilder builder) {
  ...
  public static class CreateLegalHoldPolicyAssignmentHeadersBuilder {
    ...
    public CreateLegalHoldPolicyAssignmentHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
