...
public class CreateLegalHoldPolicyAssignmentRequestBody {
  ...
  public CreateLegalHoldPolicyAssignmentRequestBody(@JsonProperty("policy_id") String policyId, @JsonProperty("assign_to") CreateLegalHoldPolicyAssignmentRequestBodyAssignToField assignTo) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLegalHoldPolicyAssignmentRequestBody casted = (CreateLegalHoldPolicyAssignmentRequestBody) o;
  ...
  public String toString() {
    return "CreateLegalHoldPolicyAssignmentRequestBody{" + "policyId='" + policyId + '\'' + ", " + "assignTo='" + assignTo + '\'' + "}";
  }
