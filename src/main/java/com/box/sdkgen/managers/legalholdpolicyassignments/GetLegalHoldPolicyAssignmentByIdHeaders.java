...
public class GetLegalHoldPolicyAssignmentByIdHeaders {
  ...
  protected GetLegalHoldPolicyAssignmentByIdHeaders(GetLegalHoldPolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class GetLegalHoldPolicyAssignmentByIdHeadersBuilder {
    ...
    public GetLegalHoldPolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
