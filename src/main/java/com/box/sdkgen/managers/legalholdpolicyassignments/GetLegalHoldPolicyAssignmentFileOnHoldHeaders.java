...
public class GetLegalHoldPolicyAssignmentFileOnHoldHeaders {
  ...
  protected GetLegalHoldPolicyAssignmentFileOnHoldHeaders(GetLegalHoldPolicyAssignmentFileOnHoldHeadersBuilder builder) {
  ...
  public static class GetLegalHoldPolicyAssignmentFileOnHoldHeadersBuilder {
    ...
    public GetLegalHoldPolicyAssignmentFileOnHoldHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
