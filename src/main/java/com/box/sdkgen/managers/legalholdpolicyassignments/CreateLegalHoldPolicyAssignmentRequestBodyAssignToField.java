...
public class CreateLegalHoldPolicyAssignmentRequestBodyAssignToField {
  ...
  public CreateLegalHoldPolicyAssignmentRequestBodyAssignToField(@JsonProperty("type") EnumWrapper<CreateLegalHoldPolicyAssignmentRequestBodyAssignToTypeField> type, @JsonProperty("id") String id) {
    this.type = type;
    this.id = id;
  }
  ...
  public CreateLegalHoldPolicyAssignmentRequestBodyAssignToField(CreateLegalHoldPolicyAssignmentRequestBodyAssignToTypeField type, String id) {
    this.type = new EnumWrapper<CreateLegalHoldPolicyAssignmentRequestBodyAssignToTypeField>(type.getValue(), type);
    this.id = id;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateLegalHoldPolicyAssignmentRequestBodyAssignToField casted = (CreateLegalHoldPolicyAssignmentRequestBodyAssignToField) o;
  ...
  public String toString() {
    return "CreateLegalHoldPolicyAssignmentRequestBodyAssignToField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
