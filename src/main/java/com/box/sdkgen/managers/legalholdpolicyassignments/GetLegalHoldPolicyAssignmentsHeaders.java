...
public class GetLegalHoldPolicyAssignmentsHeaders {
  ...
  protected GetLegalHoldPolicyAssignmentsHeaders(GetLegalHoldPolicyAssignmentsHeadersBuilder builder) {
  ...
  public static class GetLegalHoldPolicyAssignmentsHeadersBuilder {
    ...
    public GetLegalHoldPolicyAssignmentsHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
