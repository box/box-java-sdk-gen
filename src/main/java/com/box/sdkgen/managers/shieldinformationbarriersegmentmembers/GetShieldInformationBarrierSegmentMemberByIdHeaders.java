...
public class GetShieldInformationBarrierSegmentMemberByIdHeaders {
  ...
  protected GetShieldInformationBarrierSegmentMemberByIdHeaders(GetShieldInformationBarrierSegmentMemberByIdHeadersBuilder builder) {
  ...
  public static class GetShieldInformationBarrierSegmentMemberByIdHeadersBuilder {
    ...
    public GetShieldInformationBarrierSegmentMemberByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
