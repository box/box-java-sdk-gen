...
public class GetShieldInformationBarrierSegmentMembersHeaders {
  ...
  protected GetShieldInformationBarrierSegmentMembersHeaders(GetShieldInformationBarrierSegmentMembersHeadersBuilder builder) {
  ...
  public static class GetShieldInformationBarrierSegmentMembersHeadersBuilder {
    ...
    public GetShieldInformationBarrierSegmentMembersHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
