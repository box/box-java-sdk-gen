...
public class GetMetadataCascadePoliciesQueryParams {
  ...
  protected GetMetadataCascadePoliciesQueryParams(GetMetadataCascadePoliciesQueryParamsBuilder builder) {
  ...
  public static class GetMetadataCascadePoliciesQueryParamsBuilder {
    ...
    public GetMetadataCascadePoliciesQueryParamsBuilder ownerEnterpriseId(String ownerEnterpriseId) {
