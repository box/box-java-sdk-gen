...
public class GetMetadataCascadePolicyByIdHeaders {
  ...
  protected GetMetadataCascadePolicyByIdHeaders(GetMetadataCascadePolicyByIdHeadersBuilder builder) {
  ...
  public static class GetMetadataCascadePolicyByIdHeadersBuilder {
    ...
    public GetMetadataCascadePolicyByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
