...
public class DeleteMetadataCascadePolicyByIdHeaders {
  ...
  protected DeleteMetadataCascadePolicyByIdHeaders(DeleteMetadataCascadePolicyByIdHeadersBuilder builder) {
  ...
  public static class DeleteMetadataCascadePolicyByIdHeadersBuilder {
    ...
    public DeleteMetadataCascadePolicyByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
