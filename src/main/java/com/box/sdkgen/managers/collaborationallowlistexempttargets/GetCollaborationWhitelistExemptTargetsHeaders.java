...
public class GetCollaborationWhitelistExemptTargetsHeaders {
  ...
  protected GetCollaborationWhitelistExemptTargetsHeaders(GetCollaborationWhitelistExemptTargetsHeadersBuilder builder) {
  ...
  public static class GetCollaborationWhitelistExemptTargetsHeadersBuilder {
    ...
    public GetCollaborationWhitelistExemptTargetsHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
