...
public class UpdateAllSkillCardsOnFileRequestBodyMetadataField {
  ...
  protected UpdateAllSkillCardsOnFileRequestBodyMetadataField(UpdateAllSkillCardsOnFileRequestBodyMetadataFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAllSkillCardsOnFileRequestBodyMetadataField casted = (UpdateAllSkillCardsOnFileRequestBodyMetadataField) o;
  ...
  public static class UpdateAllSkillCardsOnFileRequestBodyMetadataFieldBuilder {
    ...
    public UpdateAllSkillCardsOnFileRequestBodyMetadataFieldBuilder cards(List<KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard> cards) {
      this.cards = cards;
      return this;
    }
