...
public class UpdateAllSkillCardsOnFileRequestBodyFileVersionField {
  ...
  protected UpdateAllSkillCardsOnFileRequestBodyFileVersionField(UpdateAllSkillCardsOnFileRequestBodyFileVersionFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAllSkillCardsOnFileRequestBodyFileVersionField casted = (UpdateAllSkillCardsOnFileRequestBodyFileVersionField) o;
  ...
  public String toString() {
    return "UpdateAllSkillCardsOnFileRequestBodyFileVersionField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class UpdateAllSkillCardsOnFileRequestBodyFileVersionFieldBuilder {
    ...
    public UpdateAllSkillCardsOnFileRequestBodyFileVersionFieldBuilder type(UpdateAllSkillCardsOnFileRequestBodyFileVersionTypeField type) {
      this.type = new EnumWrapper<UpdateAllSkillCardsOnFileRequestBodyFileVersionTypeField>(type.getValue(), type);
      return this;
    }
