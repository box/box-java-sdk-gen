...
public enum GetSlackIntegrationMappingQueryParamsPartnerItemTypeField {
  CHANNEL("channel");
  ...
  public static class GetSlackIntegrationMappingQueryParamsPartnerItemTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<GetSlackIntegrationMappingQueryParamsPartnerItemTypeField>> {
    ...
    @Override
    public EnumWrapper<GetSlackIntegrationMappingQueryParamsPartnerItemTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(GetSlackIntegrationMappingQueryParamsPartnerItemTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<GetSlackIntegrationMappingQueryParamsPartnerItemTypeField>(value, v)).orElse(new EnumWrapper<GetSlackIntegrationMappingQueryParamsPartnerItemTypeField>(value));
    }

  }

  public static class GetSlackIntegrationMappingQueryParamsPartnerItemTypeFieldSerializer extends JsonSerializer<EnumWrapper<GetSlackIntegrationMappingQueryParamsPartnerItemTypeField>> {
