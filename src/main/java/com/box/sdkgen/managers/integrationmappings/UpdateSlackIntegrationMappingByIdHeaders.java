...
public class UpdateSlackIntegrationMappingByIdHeaders {
  ...
  protected UpdateSlackIntegrationMappingByIdHeaders(UpdateSlackIntegrationMappingByIdHeadersBuilder builder) {
  ...
  public static class UpdateSlackIntegrationMappingByIdHeadersBuilder {
    ...
    public UpdateSlackIntegrationMappingByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
