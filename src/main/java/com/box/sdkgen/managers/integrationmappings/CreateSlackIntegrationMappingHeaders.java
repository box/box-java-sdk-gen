...
public class CreateSlackIntegrationMappingHeaders {
  ...
  protected CreateSlackIntegrationMappingHeaders(CreateSlackIntegrationMappingHeadersBuilder builder) {
  ...
  public static class CreateSlackIntegrationMappingHeadersBuilder {
    ...
    public CreateSlackIntegrationMappingHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
