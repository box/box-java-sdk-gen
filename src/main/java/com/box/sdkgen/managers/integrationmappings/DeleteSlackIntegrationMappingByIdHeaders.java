...
public class DeleteSlackIntegrationMappingByIdHeaders {
  ...
  protected DeleteSlackIntegrationMappingByIdHeaders(DeleteSlackIntegrationMappingByIdHeadersBuilder builder) {
  ...
  public static class DeleteSlackIntegrationMappingByIdHeadersBuilder {
    ...
    public DeleteSlackIntegrationMappingByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
