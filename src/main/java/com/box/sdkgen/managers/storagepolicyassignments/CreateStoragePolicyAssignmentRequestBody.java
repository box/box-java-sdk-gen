...
public class CreateStoragePolicyAssignmentRequestBody {
  ...
  public CreateStoragePolicyAssignmentRequestBody(@JsonProperty("storage_policy") CreateStoragePolicyAssignmentRequestBodyStoragePolicyField storagePolicy, @JsonProperty("assigned_to") CreateStoragePolicyAssignmentRequestBodyAssignedToField assignedTo) {
  ...
  public int hashCode() {
    return Objects.hash(
      storagePolicy, assignedTo
    );
  }

  @Override
  public String toString() {
    return "CreateStoragePolicyAssignmentRequestBody{" + "storagePolicy='" + storagePolicy + '\'' + ", " + "assignedTo='" + assignedTo + '\'' + "}";
  }
