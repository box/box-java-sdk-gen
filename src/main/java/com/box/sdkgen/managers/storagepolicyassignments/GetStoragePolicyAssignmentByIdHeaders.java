...
public class GetStoragePolicyAssignmentByIdHeaders {
  ...
  protected GetStoragePolicyAssignmentByIdHeaders(GetStoragePolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class GetStoragePolicyAssignmentByIdHeadersBuilder {
    ...
    public GetStoragePolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
