...
public class UpdateStoragePolicyAssignmentByIdRequestBody {
  ...
  public UpdateStoragePolicyAssignmentByIdRequestBody(@JsonProperty("storage_policy") UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField storagePolicy) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateStoragePolicyAssignmentByIdRequestBody casted = (UpdateStoragePolicyAssignmentByIdRequestBody) o;
  ...
  public String toString() {
    return "UpdateStoragePolicyAssignmentByIdRequestBody{" + "storagePolicy='" + storagePolicy + '\'' + "}";
  }
