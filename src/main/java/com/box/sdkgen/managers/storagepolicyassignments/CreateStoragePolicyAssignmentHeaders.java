...
public class CreateStoragePolicyAssignmentHeaders {
  ...
  protected CreateStoragePolicyAssignmentHeaders(CreateStoragePolicyAssignmentHeadersBuilder builder) {
  ...
  public static class CreateStoragePolicyAssignmentHeadersBuilder {
    ...
    public CreateStoragePolicyAssignmentHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
