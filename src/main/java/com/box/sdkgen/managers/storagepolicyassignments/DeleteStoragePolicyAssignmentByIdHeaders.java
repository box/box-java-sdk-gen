...
public class DeleteStoragePolicyAssignmentByIdHeaders {
  ...
  protected DeleteStoragePolicyAssignmentByIdHeaders(DeleteStoragePolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class DeleteStoragePolicyAssignmentByIdHeadersBuilder {
    ...
    public DeleteStoragePolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
