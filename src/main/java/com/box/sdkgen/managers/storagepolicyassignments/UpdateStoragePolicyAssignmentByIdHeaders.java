...
public class UpdateStoragePolicyAssignmentByIdHeaders {
  ...
  protected UpdateStoragePolicyAssignmentByIdHeaders(UpdateStoragePolicyAssignmentByIdHeadersBuilder builder) {
  ...
  public static class UpdateStoragePolicyAssignmentByIdHeadersBuilder {
    ...
    public UpdateStoragePolicyAssignmentByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
