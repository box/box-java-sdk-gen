...
public class RetentionPoliciesManager {
  ...
  protected RetentionPoliciesManager(RetentionPoliciesManagerBuilder builder) {
    this.auth = builder.auth;
    this.networkSession = builder.networkSession;
  }

  public RetentionPolicies getRetentionPolicies() {
    return getRetentionPolicies(new GetRetentionPoliciesQueryParams(), new GetRetentionPoliciesHeaders());
  }
  ...
  public RetentionPolicies getRetentionPolicies(GetRetentionPoliciesQueryParams queryParams, GetRetentionPoliciesHeaders headers) {
    Map<String, String> queryParamsMap = prepareParams(mapOf(entryOf("policy_name", convertToString(queryParams.getPolicyName())), entryOf("policy_type", convertToString(queryParams.getPolicyType())), entryOf("created_by_user_id", convertToString(queryParams.getCreatedByUserId())), entryOf("fields", convertToString(queryParams.getFields())), entryOf("limit", convertToString(queryParams.getLimit())), entryOf("marker", convertToString(queryParams.getMarker()))));
    Map<String, String> headersMap = prepareParams(mergeMaps(mapOf(), headers.getExtraHeaders()));
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/retention_policies")).method("GET").params(queryParamsMap).headers(headersMap).responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
  ...
  public RetentionPolicy getRetentionPolicyById(String retentionPolicyId) {
    return getRetentionPolicyById(retentionPolicyId, new GetRetentionPolicyByIdQueryParams(), new GetRetentionPolicyByIdHeaders());
  }

  public RetentionPolicy getRetentionPolicyById(String retentionPolicyId, GetRetentionPolicyByIdQueryParams queryParams) {
    return getRetentionPolicyById(retentionPolicyId, queryParams, new GetRetentionPolicyByIdHeaders());
  }

  public RetentionPolicy getRetentionPolicyById(String retentionPolicyId, GetRetentionPolicyByIdHeaders headers) {
    return getRetentionPolicyById(retentionPolicyId, new GetRetentionPolicyByIdQueryParams(), headers);
  }
  ...
  public RetentionPolicy getRetentionPolicyById(String retentionPolicyId, GetRetentionPolicyByIdQueryParams queryParams, GetRetentionPolicyByIdHeaders headers) {
    ...
    Map<String, String> headersMap = prepareParams(mergeMaps(mapOf(), headers.getExtraHeaders()));
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/retention_policies/", convertToString(retentionPolicyId))).method("GET").params(queryParamsMap).headers(headersMap).responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
    return JsonManager.deserialize(response.getData(), RetentionPolicy.class);
  }

  public RetentionPolicy updateRetentionPolicyById(String retentionPolicyId) {
    return updateRetentionPolicyById(retentionPolicyId, new UpdateRetentionPolicyByIdRequestBody(), new UpdateRetentionPolicyByIdHeaders());
  }
  ...
  public RetentionPolicy updateRetentionPolicyById(String retentionPolicyId, UpdateRetentionPolicyByIdRequestBody requestBody) {
    return updateRetentionPolicyById(retentionPolicyId, requestBody, new UpdateRetentionPolicyByIdHeaders());
  }

  public RetentionPolicy updateRetentionPolicyById(String retentionPolicyId, UpdateRetentionPolicyByIdHeaders headers) {
    return updateRetentionPolicyById(retentionPolicyId, new UpdateRetentionPolicyByIdRequestBody(), headers);
  }
  ...
  public RetentionPolicy updateRetentionPolicyById(String retentionPolicyId, UpdateRetentionPolicyByIdRequestBody requestBody, UpdateRetentionPolicyByIdHeaders headers) {
    Map<String, String> headersMap = prepareParams(mergeMaps(mapOf(), headers.getExtraHeaders()));
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/retention_policies/", convertToString(retentionPolicyId))).method("PUT").headers(headersMap).data(JsonManager.serialize(requestBody)).contentType("application/json").responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
    return JsonManager.deserialize(response.getData(), RetentionPolicy.class);
  }
  ...
  public void deleteRetentionPolicyById(String retentionPolicyId, DeleteRetentionPolicyByIdHeaders headers) {
    Map<String, String> headersMap = prepareParams(mergeMaps(mapOf(), headers.getExtraHeaders()));
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/retention_policies/", convertToString(retentionPolicyId))).method("DELETE").headers(headersMap).responseFormat(null).auth(this.auth).networkSession(this.networkSession).build());
  }
  ...
  public static class RetentionPoliciesManagerBuilder {
    ...
    public RetentionPoliciesManagerBuilder networkSession(NetworkSession networkSession) {
