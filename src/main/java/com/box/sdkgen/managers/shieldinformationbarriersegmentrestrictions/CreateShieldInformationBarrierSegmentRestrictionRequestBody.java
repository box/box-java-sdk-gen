...
public class CreateShieldInformationBarrierSegmentRestrictionRequestBody {
  ...
  public CreateShieldInformationBarrierSegmentRestrictionRequestBody(@JsonProperty("shield_information_barrier_segment") CreateShieldInformationBarrierSegmentRestrictionRequestBodyShieldInformationBarrierSegmentField shieldInformationBarrierSegment, @JsonProperty("restricted_segment") CreateShieldInformationBarrierSegmentRestrictionRequestBodyRestrictedSegmentField restrictedSegment) {
    this.shieldInformationBarrierSegment = shieldInformationBarrierSegment;
    this.restrictedSegment = restrictedSegment;
    this.type = new EnumWrapper<CreateShieldInformationBarrierSegmentRestrictionRequestBodyTypeField>(CreateShieldInformationBarrierSegmentRestrictionRequestBodyTypeField.SHIELD_INFORMATION_BARRIER_SEGMENT_RESTRICTION.getValue(), CreateShieldInformationBarrierSegmentRestrictionRequestBodyTypeField.SHIELD_INFORMATION_BARRIER_SEGMENT_RESTRICTION);
  }

  protected CreateShieldInformationBarrierSegmentRestrictionRequestBody(CreateShieldInformationBarrierSegmentRestrictionRequestBodyBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    CreateShieldInformationBarrierSegmentRestrictionRequestBody casted = (CreateShieldInformationBarrierSegmentRestrictionRequestBody) o;
  ...
  public String toString() {
    return "CreateShieldInformationBarrierSegmentRestrictionRequestBody{" + "type='" + type + '\'' + ", " + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + ", " + "shieldInformationBarrierSegment='" + shieldInformationBarrierSegment + '\'' + ", " + "restrictedSegment='" + restrictedSegment + '\'' + "}";
  }
  ...
  public static class CreateShieldInformationBarrierSegmentRestrictionRequestBodyBuilder {
    ...
    public CreateShieldInformationBarrierSegmentRestrictionRequestBodyBuilder type(CreateShieldInformationBarrierSegmentRestrictionRequestBodyTypeField type) {
      this.type = new EnumWrapper<CreateShieldInformationBarrierSegmentRestrictionRequestBodyTypeField>(type.getValue(), type);
      return this;
    }

    public CreateShieldInformationBarrierSegmentRestrictionRequestBodyBuilder shieldInformationBarrier(ShieldInformationBarrierBase shieldInformationBarrier) {
