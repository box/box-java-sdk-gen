...
public class GetShieldInformationBarrierSegmentRestrictionByIdHeaders {
  ...
  protected GetShieldInformationBarrierSegmentRestrictionByIdHeaders(GetShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder builder) {
  ...
  public static class GetShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder {
    ...
    public GetShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
