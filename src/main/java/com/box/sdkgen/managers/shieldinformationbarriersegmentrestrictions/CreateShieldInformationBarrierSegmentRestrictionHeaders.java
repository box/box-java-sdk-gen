...
public class CreateShieldInformationBarrierSegmentRestrictionHeaders {
  ...
  protected CreateShieldInformationBarrierSegmentRestrictionHeaders(CreateShieldInformationBarrierSegmentRestrictionHeadersBuilder builder) {
  ...
  public static class CreateShieldInformationBarrierSegmentRestrictionHeadersBuilder {
    ...
    public CreateShieldInformationBarrierSegmentRestrictionHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
