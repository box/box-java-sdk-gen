...
public class DeleteShieldInformationBarrierSegmentRestrictionByIdHeaders {
  ...
  protected DeleteShieldInformationBarrierSegmentRestrictionByIdHeaders(DeleteShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder builder) {
  ...
  public static class DeleteShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder {
    ...
    public DeleteShieldInformationBarrierSegmentRestrictionByIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
