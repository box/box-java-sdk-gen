...
public class AddClassificationToFileRequestBody {
  ...
  public String toString() {
    return "AddClassificationToFileRequestBody{" + "boxSecurityClassificationKey='" + boxSecurityClassificationKey + '\'' + "}";
  }
  ...
  public static class AddClassificationToFileRequestBodyBuilder {
    ...
    public AddClassificationToFileRequestBodyBuilder boxSecurityClassificationKey(String boxSecurityClassificationKey) {
