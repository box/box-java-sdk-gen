...
public class DeleteClassificationFromFileHeaders {
  ...
  protected DeleteClassificationFromFileHeaders(DeleteClassificationFromFileHeadersBuilder builder) {
  ...
  public static class DeleteClassificationFromFileHeadersBuilder {
    ...
    public DeleteClassificationFromFileHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
