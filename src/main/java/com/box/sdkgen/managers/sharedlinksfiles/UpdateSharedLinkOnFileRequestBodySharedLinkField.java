...
public class UpdateSharedLinkOnFileRequestBodySharedLinkField {
  ...
  protected UpdateSharedLinkOnFileRequestBodySharedLinkField(UpdateSharedLinkOnFileRequestBodySharedLinkFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSharedLinkOnFileRequestBodySharedLinkField casted = (UpdateSharedLinkOnFileRequestBodySharedLinkField) o;
  ...
  public String toString() {
    return "UpdateSharedLinkOnFileRequestBodySharedLinkField{" + "access='" + access + '\'' + ", " + "password='" + password + '\'' + ", " + "vanityName='" + vanityName + '\'' + ", " + "unsharedAt='" + unsharedAt + '\'' + ", " + "permissions='" + permissions + '\'' + "}";
  }
  ...
  public static class UpdateSharedLinkOnFileRequestBodySharedLinkFieldBuilder {
    ...
    public UpdateSharedLinkOnFileRequestBodySharedLinkFieldBuilder access(UpdateSharedLinkOnFileRequestBodySharedLinkAccessField access) {
      this.access = new EnumWrapper<UpdateSharedLinkOnFileRequestBodySharedLinkAccessField>(access.getValue(), access);
      return this;
    }
    ...
    public UpdateSharedLinkOnFileRequestBodySharedLinkFieldBuilder permissions(UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField permissions) {
