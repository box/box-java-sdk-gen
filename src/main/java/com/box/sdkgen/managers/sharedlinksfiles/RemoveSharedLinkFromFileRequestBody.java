...
public class RemoveSharedLinkFromFileRequestBody {
  ...
  protected RemoveSharedLinkFromFileRequestBody(RemoveSharedLinkFromFileRequestBodyBuilder builder) {
  ...
  public static class RemoveSharedLinkFromFileRequestBodyBuilder {
    ...
    public RemoveSharedLinkFromFileRequestBodyBuilder sharedLink(RemoveSharedLinkFromFileRequestBodySharedLinkField sharedLink) {
