...
public class UpdateSharedLinkOnFolderRequestBody {
  ...
  protected UpdateSharedLinkOnFolderRequestBody(UpdateSharedLinkOnFolderRequestBodyBuilder builder) {
  ...
  public static class UpdateSharedLinkOnFolderRequestBodyBuilder {
    ...
    public UpdateSharedLinkOnFolderRequestBodyBuilder sharedLink(UpdateSharedLinkOnFolderRequestBodySharedLinkField sharedLink) {
