...
public class CreateCommentRequestBodyItemField {
  ...
  @JsonDeserialize(using = CreateCommentRequestBodyItemTypeField.CreateCommentRequestBodyItemTypeFieldDeserializer.class)
  @JsonSerialize(using = CreateCommentRequestBodyItemTypeField.CreateCommentRequestBodyItemTypeFieldSerializer.class)
  protected final EnumWrapper<CreateCommentRequestBodyItemTypeField> type;

  public CreateCommentRequestBodyItemField(@JsonProperty("id") String id, @JsonProperty("type") EnumWrapper<CreateCommentRequestBodyItemTypeField> type) {
    this.id = id;
    this.type = type;
  }
  ...
  public String toString() {
    return "CreateCommentRequestBodyItemField{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + "}";
  }
