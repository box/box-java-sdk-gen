...
public class UpdateFileByIdRequestBodySharedLinkPermissionsField {
  ...
  protected UpdateFileByIdRequestBodySharedLinkPermissionsField(UpdateFileByIdRequestBodySharedLinkPermissionsFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFileByIdRequestBodySharedLinkPermissionsField casted = (UpdateFileByIdRequestBodySharedLinkPermissionsField) o;
  ...
  public String toString() {
    return "UpdateFileByIdRequestBodySharedLinkPermissionsField{" + "canDownload='" + canDownload + '\'' + "}";
  }
  ...
  public static class UpdateFileByIdRequestBodySharedLinkPermissionsFieldBuilder {
    ...
    public UpdateFileByIdRequestBodySharedLinkPermissionsFieldBuilder canDownload(Boolean canDownload) {
