...
public enum CreateWebhookRequestBodyTriggersField {
  ...
  CreateWebhookRequestBodyTriggersField(String value) {
    this.value = value;
  }
  ...
  public static class CreateWebhookRequestBodyTriggersFieldDeserializer
      extends JsonDeserializer<EnumWrapper<CreateWebhookRequestBodyTriggersField>> {

    public CreateWebhookRequestBodyTriggersFieldDeserializer() {
      super();
    }

    @Override
    public EnumWrapper<CreateWebhookRequestBodyTriggersField> deserialize(
        JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(CreateWebhookRequestBodyTriggersField.values())
          .filter((v) -> v.getValue().equalsIgnoreCase(value))
          .findFirst()
          .map((v) -> new EnumWrapper<CreateWebhookRequestBodyTriggersField>(value, v))
          .orElse(new EnumWrapper<CreateWebhookRequestBodyTriggersField>(value));
    }
  }

  public static class CreateWebhookRequestBodyTriggersFieldSerializer
      extends JsonSerializer<EnumWrapper<CreateWebhookRequestBodyTriggersField>> {

    public CreateWebhookRequestBodyTriggersFieldSerializer() {
      super();
    }

    @Override
    public void serialize(
        EnumWrapper<CreateWebhookRequestBodyTriggersField> value,
        JsonGenerator gen,
