...
public class UpdateWebhookByIdRequestBody {
  ...
  public String toString() {
    return "UpdateWebhookByIdRequestBody{" + "target='" + target + '\'' + ", " + "address='" + address + '\'' + ", " + "triggers='" + triggers + '\'' + "}";
  }
  ...
  public static class UpdateWebhookByIdRequestBodyBuilder {
    ...
    public UpdateWebhookByIdRequestBodyBuilder target(UpdateWebhookByIdRequestBodyTargetField target) {
      this.target = target;
      return this;
    }
    ...
    public UpdateWebhookByIdRequestBodyBuilder triggers(List<UpdateWebhookByIdRequestBodyTriggersField> triggers) {
