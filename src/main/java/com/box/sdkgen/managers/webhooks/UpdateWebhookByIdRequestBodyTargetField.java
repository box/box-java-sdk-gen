...
public class UpdateWebhookByIdRequestBodyTargetField {
  ...
  protected UpdateWebhookByIdRequestBodyTargetField(UpdateWebhookByIdRequestBodyTargetFieldBuilder builder) {
    this.id = builder.id;
  ...
  public String toString() {
    return "UpdateWebhookByIdRequestBodyTargetField{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + "}";
  }
  ...
  public static class UpdateWebhookByIdRequestBodyTargetFieldBuilder {
    ...
    public UpdateWebhookByIdRequestBodyTargetFieldBuilder type(UpdateWebhookByIdRequestBodyTargetTypeField type) {
      this.type = new EnumWrapper<UpdateWebhookByIdRequestBodyTargetTypeField>(type.getValue(), type);
      return this;
    }
