...
public class CreateCollaborationRequestBodyItemField {
  ...
  protected CreateCollaborationRequestBodyItemField(CreateCollaborationRequestBodyItemFieldBuilder builder) {
  ...
  public String toString() {
    return "CreateCollaborationRequestBodyItemField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class CreateCollaborationRequestBodyItemFieldBuilder {
    ...
    public CreateCollaborationRequestBodyItemFieldBuilder type(CreateCollaborationRequestBodyItemTypeField type) {
      this.type = new EnumWrapper<CreateCollaborationRequestBodyItemTypeField>(type.getValue(), type);
      return this;
    }
