...
public class GetTermsOfServiceQueryParams {
  ...
  public static class GetTermsOfServiceQueryParamsBuilder {
    ...
    public GetTermsOfServiceQueryParamsBuilder tosType(GetTermsOfServiceQueryParamsTosTypeField tosType) {
      this.tosType = new EnumWrapper<GetTermsOfServiceQueryParamsTosTypeField>(tosType.getValue(), tosType);
      return this;
    }
