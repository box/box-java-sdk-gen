...
public class ShieldInformationBarrierReportsManager {
  ...
  protected ShieldInformationBarrierReportsManager(
      ShieldInformationBarrierReportsManagerBuilder builder) {
  ...
  public static class ShieldInformationBarrierReportsManagerBuilder {
    ...
    public ShieldInformationBarrierReportsManagerBuilder networkSession(
