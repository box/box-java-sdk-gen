...
public class UpdateClassificationOnFolderHeaders {
  ...
  protected UpdateClassificationOnFolderHeaders(UpdateClassificationOnFolderHeadersBuilder builder) {
  ...
  public static class UpdateClassificationOnFolderHeadersBuilder {
    ...
    public UpdateClassificationOnFolderHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
