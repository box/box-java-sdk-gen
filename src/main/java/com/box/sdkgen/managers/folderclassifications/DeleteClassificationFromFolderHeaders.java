...
public class DeleteClassificationFromFolderHeaders {
  ...
  protected DeleteClassificationFromFolderHeaders(DeleteClassificationFromFolderHeadersBuilder builder) {
  ...
  public static class DeleteClassificationFromFolderHeadersBuilder {
    ...
    public DeleteClassificationFromFolderHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
