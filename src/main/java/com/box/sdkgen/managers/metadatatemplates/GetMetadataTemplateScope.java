...
public enum GetMetadataTemplateScope {
  ...
  public static class GetMetadataTemplateScopeDeserializer extends JsonDeserializer<EnumWrapper<GetMetadataTemplateScope>> {
    ...
    public EnumWrapper<GetMetadataTemplateScope> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      return Arrays.stream(GetMetadataTemplateScope.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<GetMetadataTemplateScope>(value, v)).orElse(new EnumWrapper<GetMetadataTemplateScope>(value));
    }
  ...
  public static class GetMetadataTemplateScopeSerializer extends JsonSerializer<EnumWrapper<GetMetadataTemplateScope>> {
    ...
    @Override
    public void serialize(EnumWrapper<GetMetadataTemplateScope> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
