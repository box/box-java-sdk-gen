...
public class GetEnterpriseMetadataTemplatesHeaders {
  ...
  protected GetEnterpriseMetadataTemplatesHeaders(GetEnterpriseMetadataTemplatesHeadersBuilder builder) {
  ...
  public static class GetEnterpriseMetadataTemplatesHeadersBuilder {
    ...
    public GetEnterpriseMetadataTemplatesHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
