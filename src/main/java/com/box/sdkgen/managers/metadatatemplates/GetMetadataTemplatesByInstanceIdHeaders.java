...
public class GetMetadataTemplatesByInstanceIdHeaders {
  ...
  protected GetMetadataTemplatesByInstanceIdHeaders(GetMetadataTemplatesByInstanceIdHeadersBuilder builder) {
  ...
  public static class GetMetadataTemplatesByInstanceIdHeadersBuilder {
    ...
    public GetMetadataTemplatesByInstanceIdHeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
