...
public enum CreateMetadataTemplateRequestBodyFieldsTypeField {
  ...
  public static class CreateMetadataTemplateRequestBodyFieldsTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField>> {
    ...
    @Override
    public EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(CreateMetadataTemplateRequestBodyFieldsTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField>(value, v)).orElse(new EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField>(value));
    }
  ...
  public static class CreateMetadataTemplateRequestBodyFieldsTypeFieldSerializer extends JsonSerializer<EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<CreateMetadataTemplateRequestBodyFieldsTypeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
