...
public class StartWorkflowRequestBodyFolderField {
  ...
  protected StartWorkflowRequestBodyFolderField(StartWorkflowRequestBodyFolderFieldBuilder builder) {
  ...
  public String toString() {
    return "StartWorkflowRequestBodyFolderField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class StartWorkflowRequestBodyFolderFieldBuilder {
    ...
    public StartWorkflowRequestBodyFolderFieldBuilder type(StartWorkflowRequestBodyFolderTypeField type) {
