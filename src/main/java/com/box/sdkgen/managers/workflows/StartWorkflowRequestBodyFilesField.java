...
public class StartWorkflowRequestBodyFilesField {
  ...
  public String toString() {
    return "StartWorkflowRequestBodyFilesField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class StartWorkflowRequestBodyFilesFieldBuilder {
    ...
    public StartWorkflowRequestBodyFilesFieldBuilder type(StartWorkflowRequestBodyFilesTypeField type) {
