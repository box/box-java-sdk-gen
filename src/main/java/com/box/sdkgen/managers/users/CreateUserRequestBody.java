...
public class CreateUserRequestBody {
  ...
  public int hashCode() {
    return Objects.hash(
      name, login, isPlatformAccessOnly, role, language, isSyncEnabled, jobTitle, phone, address, spaceAmount, trackingCodes, canSeeManagedUsers, timezone, isExternalCollabRestricted, isExemptFromDeviceLimits, isExemptFromLoginVerification, status, externalAppUserId
    );
  }

  @Override
  public String toString() {
    return "CreateUserRequestBody{" + "name='" + name + '\'' + ", " + "login='" + login + '\'' + ", " + "isPlatformAccessOnly='" + isPlatformAccessOnly + '\'' + ", " + "role='" + role + '\'' + ", " + "language='" + language + '\'' + ", " + "isSyncEnabled='" + isSyncEnabled + '\'' + ", " + "jobTitle='" + jobTitle + '\'' + ", " + "phone='" + phone + '\'' + ", " + "address='" + address + '\'' + ", " + "spaceAmount='" + spaceAmount + '\'' + ", " + "trackingCodes='" + trackingCodes + '\'' + ", " + "canSeeManagedUsers='" + canSeeManagedUsers + '\'' + ", " + "timezone='" + timezone + '\'' + ", " + "isExternalCollabRestricted='" + isExternalCollabRestricted + '\'' + ", " + "isExemptFromDeviceLimits='" + isExemptFromDeviceLimits + '\'' + ", " + "isExemptFromLoginVerification='" + isExemptFromLoginVerification + '\'' + ", " + "status='" + status + '\'' + ", " + "externalAppUserId='" + externalAppUserId + '\'' + "}";
  }
  ...
  public static class CreateUserRequestBodyBuilder {
    ...
    public CreateUserRequestBodyBuilder isExternalCollabRestricted(Boolean isExternalCollabRestricted) {
    ...
    public CreateUserRequestBodyBuilder isExemptFromLoginVerification(Boolean isExemptFromLoginVerification) {
