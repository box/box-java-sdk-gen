...
public class CreateDocgenBatchV2025R0Headers {
  ...
  public CreateDocgenBatchV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected CreateDocgenBatchV2025R0Headers(CreateDocgenBatchV2025R0HeadersBuilder builder) {
  ...
  public static class CreateDocgenBatchV2025R0HeadersBuilder {

    protected EnumWrapper<BoxVersionHeaderV2025R0> boxVersion;

    protected Map<String, String> extraHeaders;

    public CreateDocgenBatchV2025R0HeadersBuilder() {
      this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
      this.extraHeaders = mapOf();
    }

    public CreateDocgenBatchV2025R0HeadersBuilder boxVersion(BoxVersionHeaderV2025R0 boxVersion) {
      this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(boxVersion);
      return this;
    }

    public CreateDocgenBatchV2025R0HeadersBuilder boxVersion(
        EnumWrapper<BoxVersionHeaderV2025R0> boxVersion) {
      this.boxVersion = boxVersion;
      return this;
    }

    public CreateDocgenBatchV2025R0HeadersBuilder extraHeaders(Map<String, String> extraHeaders) {
      this.extraHeaders = extraHeaders;
      return this;
    }

    public CreateDocgenBatchV2025R0Headers build() {
      return new CreateDocgenBatchV2025R0Headers(this);
    }
  }
}
