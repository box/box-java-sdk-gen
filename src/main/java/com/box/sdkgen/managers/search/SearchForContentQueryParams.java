...
public class SearchForContentQueryParams {
  ...
  public static class SearchForContentQueryParamsBuilder {
    ...
    public SearchForContentQueryParamsBuilder recentUpdaterUserIds(List<String> recentUpdaterUserIds) {
    ...
    public SearchForContentQueryParamsBuilder contentTypes(List<SearchForContentQueryParamsContentTypesField> contentTypes) {
    ...
    public SearchForContentQueryParamsBuilder trashContent(SearchForContentQueryParamsTrashContentField trashContent) {
      this.trashContent = new EnumWrapper<SearchForContentQueryParamsTrashContentField>(trashContent.getValue(), trashContent);
      return this;
    }
    ...
    public SearchForContentQueryParamsBuilder direction(SearchForContentQueryParamsDirectionField direction) {
      this.direction = new EnumWrapper<SearchForContentQueryParamsDirectionField>(direction.getValue(), direction);
      return this;
    }
    ...
    public SearchForContentQueryParamsBuilder includeRecentSharedLinks(Boolean includeRecentSharedLinks) {
