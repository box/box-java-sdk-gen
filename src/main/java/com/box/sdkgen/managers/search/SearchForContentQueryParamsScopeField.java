...
public enum SearchForContentQueryParamsScopeField {
  ...
  public static class SearchForContentQueryParamsScopeFieldDeserializer extends JsonDeserializer<EnumWrapper<SearchForContentQueryParamsScopeField>> {
    ...
    public EnumWrapper<SearchForContentQueryParamsScopeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      return Arrays.stream(SearchForContentQueryParamsScopeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<SearchForContentQueryParamsScopeField>(value, v)).orElse(new EnumWrapper<SearchForContentQueryParamsScopeField>(value));
    }

  }

  public static class SearchForContentQueryParamsScopeFieldSerializer extends JsonSerializer<EnumWrapper<SearchForContentQueryParamsScopeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<SearchForContentQueryParamsScopeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
