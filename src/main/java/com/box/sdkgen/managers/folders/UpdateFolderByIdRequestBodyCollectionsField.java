...
public class UpdateFolderByIdRequestBodyCollectionsField {
  ...
  protected UpdateFolderByIdRequestBodyCollectionsField(UpdateFolderByIdRequestBodyCollectionsFieldBuilder builder) {
    this.id = builder.id;
  ...
  public boolean equals(Object o) {
    ...
    UpdateFolderByIdRequestBodyCollectionsField casted = (UpdateFolderByIdRequestBodyCollectionsField) o;
  ...
  public String toString() {
    return "UpdateFolderByIdRequestBodyCollectionsField{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + "}";
  }
