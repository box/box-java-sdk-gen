...
public class FoldersManager {
  ...
  public FolderFull getFolderById(String folderId, GetFolderByIdQueryParams queryParams, GetFolderByIdHeaders headers) {
    Map<String, String> queryParamsMap = prepareParams(mapOf(entryOf("fields", convertToString(queryParams.getFields())), entryOf("sort", convertToString(queryParams.getSort())), entryOf("direction", convertToString(queryParams.getDirection())), entryOf("offset", convertToString(queryParams.getOffset())), entryOf("limit", convertToString(queryParams.getLimit()))));
    ...
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/folders/", convertToString(folderId))).method("GET").params(queryParamsMap).headers(headersMap).responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
    return JsonManager.deserialize(response.getData(), FolderFull.class);
  }

  public FolderFull updateFolderById(String folderId) {
    return updateFolderById(folderId, new UpdateFolderByIdRequestBody(), new UpdateFolderByIdQueryParams(), new UpdateFolderByIdHeaders());
  }

  public FolderFull updateFolderById(String folderId, UpdateFolderByIdRequestBody requestBody) {
    return updateFolderById(folderId, requestBody, new UpdateFolderByIdQueryParams(), new UpdateFolderByIdHeaders());
  }

  public FolderFull updateFolderById(String folderId, UpdateFolderByIdQueryParams queryParams) {
    return updateFolderById(folderId, new UpdateFolderByIdRequestBody(), queryParams, new UpdateFolderByIdHeaders());
  }
  ...
  public FolderFull updateFolderById(String folderId, UpdateFolderByIdHeaders headers) {
    return updateFolderById(folderId, new UpdateFolderByIdRequestBody(), new UpdateFolderByIdQueryParams(), headers);
  }
  ...
  public FolderFull updateFolderById(String folderId, UpdateFolderByIdRequestBody requestBody, UpdateFolderByIdQueryParams queryParams, UpdateFolderByIdHeaders headers) {
    ...
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/folders/", convertToString(folderId))).method("PUT").params(queryParamsMap).headers(headersMap).data(JsonManager.serialize(requestBody)).contentType("application/json").responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
    return JsonManager.deserialize(response.getData(), FolderFull.class);
  }
  ...
  public void deleteFolderById(String folderId, DeleteFolderByIdQueryParams queryParams, DeleteFolderByIdHeaders headers) {
    Map<String, String> queryParamsMap = prepareParams(mapOf(entryOf("recursive", convertToString(queryParams.getRecursive()))));
    Map<String, String> headersMap = prepareParams(mergeMaps(mapOf(entryOf("if-match", convertToString(headers.getIfMatch()))), headers.getExtraHeaders()));
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/folders/", convertToString(folderId))).method("DELETE").params(queryParamsMap).headers(headersMap).responseFormat(null).auth(this.auth).networkSession(this.networkSession).build());
  }
  ...
  public Items getFolderItems(String folderId, GetFolderItemsQueryParams queryParams, GetFolderItemsHeaders headers) {
    Map<String, String> queryParamsMap = prepareParams(mapOf(entryOf("fields", convertToString(queryParams.getFields())), entryOf("usemarker", convertToString(queryParams.getUsemarker())), entryOf("marker", convertToString(queryParams.getMarker())), entryOf("offset", convertToString(queryParams.getOffset())), entryOf("limit", convertToString(queryParams.getLimit())), entryOf("sort", convertToString(queryParams.getSort())), entryOf("direction", convertToString(queryParams.getDirection()))));
    ...
    FetchResponse response = fetch(new FetchOptions.FetchOptionsBuilder(String.join("", this.networkSession.getBaseUrls().getBaseUrl(), "/2.0/folders/", convertToString(folderId), "/items")).method("GET").params(queryParamsMap).headers(headersMap).responseFormat("json").auth(this.auth).networkSession(this.networkSession).build());
