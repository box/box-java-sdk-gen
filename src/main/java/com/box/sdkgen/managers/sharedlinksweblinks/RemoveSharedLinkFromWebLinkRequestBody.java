...
public class RemoveSharedLinkFromWebLinkRequestBody {
  ...
  protected RemoveSharedLinkFromWebLinkRequestBody(RemoveSharedLinkFromWebLinkRequestBodyBuilder builder) {
  ...
  public static class RemoveSharedLinkFromWebLinkRequestBodyBuilder {
    ...
    public RemoveSharedLinkFromWebLinkRequestBodyBuilder sharedLink(RemoveSharedLinkFromWebLinkRequestBodySharedLinkField sharedLink) {
