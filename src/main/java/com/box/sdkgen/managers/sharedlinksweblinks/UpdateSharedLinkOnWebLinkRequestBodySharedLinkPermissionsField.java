...
public class UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField {
  ...
  protected UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField(UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField casted = (UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField) o;
  ...
  public String toString() {
    return "UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField{" + "canDownload='" + canDownload + '\'' + ", " + "canPreview='" + canPreview + '\'' + ", " + "canEdit='" + canEdit + '\'' + "}";
  }
  ...
  public static class UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsFieldBuilder {
    ...
    public UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsFieldBuilder canDownload(Boolean canDownload) {
      this.canDownload = canDownload;
      return this;
    }

    public UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsFieldBuilder canPreview(Boolean canPreview) {
      this.canPreview = canPreview;
      return this;
    }

    public UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsFieldBuilder canEdit(Boolean canEdit) {
