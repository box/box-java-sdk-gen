...
public class AppItemAssociation {
  ...
  public AppItemAssociation(@JsonProperty("id") String id, @JsonProperty("app_item") AppItem appItem, @JsonProperty("item") FileBaseOrFolderBaseOrWebLinkBase item) {
    this.id = id;
    this.appItem = appItem;
    this.item = item;
    this.type = new EnumWrapper<AppItemAssociationTypeField>(AppItemAssociationTypeField.APP_ITEM_ASSOCIATION.getValue(), AppItemAssociationTypeField.APP_ITEM_ASSOCIATION);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, appItem, item
    );
  }

  @Override
  public String toString() {
    return "AppItemAssociation{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "appItem='" + appItem + '\'' + ", " + "item='" + item + '\'' + "}";
  }
  ...
  public static class AppItemAssociationBuilder {
    ...
    public AppItemAssociationBuilder(String id, AppItem appItem, FileBaseOrFolderBaseOrWebLinkBase item) {
      this.id = id;
      this.appItem = appItem;
      this.item = item;
      this.type = new EnumWrapper<AppItemAssociationTypeField>(AppItemAssociationTypeField.APP_ITEM_ASSOCIATION.getValue(), AppItemAssociationTypeField.APP_ITEM_ASSOCIATION);
