...
public class AiLlmEndpointParamsOpenAi {
  ...
  public AiLlmEndpointParamsOpenAi() {
    this.type = new EnumWrapper<AiLlmEndpointParamsOpenAiTypeField>(AiLlmEndpointParamsOpenAiTypeField.OPENAI_PARAMS.getValue(), AiLlmEndpointParamsOpenAiTypeField.OPENAI_PARAMS);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      type, temperature, topP, frequencyPenalty, presencePenalty, stop
    );
  }

  @Override
  public String toString() {
    return "AiLlmEndpointParamsOpenAi{" + "type='" + type + '\'' + ", " + "temperature='" + temperature + '\'' + ", " + "topP='" + topP + '\'' + ", " + "frequencyPenalty='" + frequencyPenalty + '\'' + ", " + "presencePenalty='" + presencePenalty + '\'' + ", " + "stop='" + stop + '\'' + "}";
  }
