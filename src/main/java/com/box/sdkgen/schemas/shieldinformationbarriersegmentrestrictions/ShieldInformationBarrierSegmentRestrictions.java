...
public class ShieldInformationBarrierSegmentRestrictions {
  ...
  protected ShieldInformationBarrierSegmentRestrictions(ShieldInformationBarrierSegmentRestrictionsBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    ShieldInformationBarrierSegmentRestrictions casted = (ShieldInformationBarrierSegmentRestrictions) o;
  ...
  public String toString() {
    return "ShieldInformationBarrierSegmentRestrictions{" + "limit='" + limit + '\'' + ", " + "nextMarker='" + nextMarker + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierSegmentRestrictionsBuilder {
    ...
    public ShieldInformationBarrierSegmentRestrictionsBuilder entries(List<ShieldInformationBarrierSegmentRestriction> entries) {
