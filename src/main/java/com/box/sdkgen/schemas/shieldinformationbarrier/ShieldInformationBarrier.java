...
public class ShieldInformationBarrier {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, enterprise, status, createdAt, createdBy, updatedAt, updatedBy, enabledAt, enabledBy
    );
  }

  @Override
  public String toString() {
    return "ShieldInformationBarrier{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "enterprise='" + enterprise + '\'' + ", " + "status='" + status + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + ", " + "updatedBy='" + updatedBy + '\'' + ", " + "enabledAt='" + enabledAt + '\'' + ", " + "enabledBy='" + enabledBy + '\'' + "}";
  }
