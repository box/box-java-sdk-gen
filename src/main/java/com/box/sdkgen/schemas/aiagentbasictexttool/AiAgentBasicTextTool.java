...
public class AiAgentBasicTextTool extends AiAgentBasicTextToolBase {
  ...
  public String toString() {
    return "AiAgentBasicTextTool{" + "model='" + model + '\'' + ", " + "numTokensForCompletion='" + numTokensForCompletion + '\'' + ", " + "llmEndpointParams='" + llmEndpointParams + '\'' + ", " + "systemMessage='" + systemMessage + '\'' + ", " + "promptTemplate='" + promptTemplate + '\'' + "}";
  }
  ...
  public static class AiAgentBasicTextToolBuilder extends AiAgentBasicTextToolBaseBuilder {
    ...
    @Override
    public AiAgentBasicTextToolBuilder llmEndpointParams(AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi llmEndpointParams) {
