...
public class AiTextGenItemsField {
  ...
  public AiTextGenItemsField(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<AiTextGenItemsTypeField>(AiTextGenItemsTypeField.FILE.getValue(), AiTextGenItemsTypeField.FILE);
  }
  ...
  public String toString() {
    return "AiTextGenItemsField{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "content='" + content + '\'' + "}";
  }
