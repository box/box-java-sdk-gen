...
public class MetadataQueryIndex {
  ...
  public MetadataQueryIndex(@JsonProperty("type") String type, @JsonProperty("status") EnumWrapper<MetadataQueryIndexStatusField> status) {
    this.type = type;
    this.status = status;
  }
  ...
  public String toString() {
    return "MetadataQueryIndex{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "status='" + status + '\'' + ", " + "fields='" + fields + '\'' + "}";
  }
