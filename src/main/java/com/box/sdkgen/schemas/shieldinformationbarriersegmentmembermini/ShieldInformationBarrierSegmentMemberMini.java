...
public class ShieldInformationBarrierSegmentMemberMini extends ShieldInformationBarrierSegmentMemberBase {
  ...
  protected ShieldInformationBarrierSegmentMemberMini(ShieldInformationBarrierSegmentMemberMiniBuilder builder) {
    super(builder);
  ...
  public boolean equals(Object o) {
    ...
    ShieldInformationBarrierSegmentMemberMini casted = (ShieldInformationBarrierSegmentMemberMini) o;
  ...
  public String toString() {
    return "ShieldInformationBarrierSegmentMemberMini{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "user='" + user + '\'' + "}";
  }

  public static class ShieldInformationBarrierSegmentMemberMiniBuilder extends ShieldInformationBarrierSegmentMemberBaseBuilder {
    ...
    @Override
    public ShieldInformationBarrierSegmentMemberMiniBuilder type(ShieldInformationBarrierSegmentMemberBaseTypeField type) {
