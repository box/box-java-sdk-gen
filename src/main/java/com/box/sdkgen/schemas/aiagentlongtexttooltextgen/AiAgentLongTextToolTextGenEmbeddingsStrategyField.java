...
public class AiAgentLongTextToolTextGenEmbeddingsStrategyField {
  ...
  protected AiAgentLongTextToolTextGenEmbeddingsStrategyField(AiAgentLongTextToolTextGenEmbeddingsStrategyFieldBuilder builder) {
    this.id = builder.id;
  ...
  public boolean equals(Object o) {
    ...
    AiAgentLongTextToolTextGenEmbeddingsStrategyField casted = (AiAgentLongTextToolTextGenEmbeddingsStrategyField) o;
  ...
  public String toString() {
    return "AiAgentLongTextToolTextGenEmbeddingsStrategyField{" + "id='" + id + '\'' + ", " + "numTokensPerChunk='" + numTokensPerChunk + '\'' + "}";
  }
  ...
  public static class AiAgentLongTextToolTextGenEmbeddingsStrategyFieldBuilder {
    ...
    public AiAgentLongTextToolTextGenEmbeddingsStrategyFieldBuilder numTokensPerChunk(Long numTokensPerChunk) {
