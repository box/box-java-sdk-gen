...
public class AiAgentLongTextToolTextGen extends AiAgentBasicTextToolTextGen {
  ...
  public int hashCode() {
    return Objects.hash(
      model, numTokensForCompletion, llmEndpointParams, systemMessage, promptTemplate, embeddings
    );
  }

  @Override
  public String toString() {
    return "AiAgentLongTextToolTextGen{" + "model='" + model + '\'' + ", " + "numTokensForCompletion='" + numTokensForCompletion + '\'' + ", " + "llmEndpointParams='" + llmEndpointParams + '\'' + ", " + "systemMessage='" + systemMessage + '\'' + ", " + "promptTemplate='" + promptTemplate + '\'' + ", " + "embeddings='" + embeddings + '\'' + "}";
  }
  ...
  public static class AiAgentLongTextToolTextGenBuilder extends AiAgentBasicTextToolTextGenBuilder {
    ...
    public AiAgentLongTextToolTextGenBuilder embeddings(AiAgentLongTextToolTextGenEmbeddingsField embeddings) {
    ...
    @Override
    public AiAgentLongTextToolTextGenBuilder llmEndpointParams(AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi llmEndpointParams) {
