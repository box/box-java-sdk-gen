...
public class SignRequestSignerInput extends SignRequestPrefillTag {
  ...
  public String toString() {
    return "SignRequestSignerInput{" + "documentTagId='" + documentTagId + '\'' + ", " + "textValue='" + textValue + '\'' + ", " + "checkboxValue='" + checkboxValue + '\'' + ", " + "dateValue='" + dateValue + '\'' + ", " + "type='" + type + '\'' + ", " + "contentType='" + contentType + '\'' + ", " + "pageIndex='" + pageIndex + '\'' + ", " + "readOnly='" + readOnly + '\'' + "}";
  }
  ...
  public static class SignRequestSignerInputBuilder extends SignRequestPrefillTagBuilder {
    ...
    public SignRequestSignerInputBuilder contentType(SignRequestSignerInputContentTypeField contentType) {
      this.contentType = new EnumWrapper<SignRequestSignerInputContentTypeField>(contentType.getValue(), contentType);
      return this;
    }
