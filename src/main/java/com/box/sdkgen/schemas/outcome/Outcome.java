...
public class Outcome {
  ...
  public String toString() {
    return "Outcome{" + "id='" + id + '\'' + ", " + "collaborators='" + collaborators + '\'' + ", " + "completionRule='" + completionRule + '\'' + ", " + "fileCollaboratorRole='" + fileCollaboratorRole + '\'' + ", " + "taskCollaborators='" + taskCollaborators + '\'' + ", " + "role='" + role + '\'' + "}";
  }
