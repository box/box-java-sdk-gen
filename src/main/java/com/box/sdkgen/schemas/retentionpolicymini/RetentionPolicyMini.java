...
public class RetentionPolicyMini extends RetentionPolicyBase {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, policyName, retentionLength, dispositionAction
    );
  }

  @Override
  public String toString() {
    return "RetentionPolicyMini{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "policyName='" + policyName + '\'' + ", " + "retentionLength='" + retentionLength + '\'' + ", " + "dispositionAction='" + dispositionAction + '\'' + "}";
  }
  ...
  public static class RetentionPolicyMiniBuilder extends RetentionPolicyBaseBuilder {
    ...
    public RetentionPolicyMiniBuilder dispositionAction(RetentionPolicyMiniDispositionActionField dispositionAction) {
