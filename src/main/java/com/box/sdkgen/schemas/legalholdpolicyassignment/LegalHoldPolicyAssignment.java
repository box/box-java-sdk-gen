...
public class LegalHoldPolicyAssignment extends LegalHoldPolicyAssignmentBase {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, legalHoldPolicy, assignedTo, assignedBy, assignedAt, deletedAt
    );
  }

  @Override
  public String toString() {
    return "LegalHoldPolicyAssignment{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "legalHoldPolicy='" + legalHoldPolicy + '\'' + ", " + "assignedTo='" + assignedTo + '\'' + ", " + "assignedBy='" + assignedBy + '\'' + ", " + "assignedAt='" + assignedAt + '\'' + ", " + "deletedAt='" + deletedAt + '\'' + "}";
  }

  public static class LegalHoldPolicyAssignmentBuilder extends LegalHoldPolicyAssignmentBaseBuilder {
