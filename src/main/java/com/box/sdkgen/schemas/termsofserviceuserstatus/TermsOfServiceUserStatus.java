...
public class TermsOfServiceUserStatus {
  ...
  public TermsOfServiceUserStatus(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<TermsOfServiceUserStatusTypeField>(TermsOfServiceUserStatusTypeField.TERMS_OF_SERVICE_USER_STATUS.getValue(), TermsOfServiceUserStatusTypeField.TERMS_OF_SERVICE_USER_STATUS);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, tos, user, isAccepted, createdAt, modifiedAt
    );
  }

  @Override
  public String toString() {
    return "TermsOfServiceUserStatus{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "tos='" + tos + '\'' + ", " + "user='" + user + '\'' + ", " + "isAccepted='" + isAccepted + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + "}";
  }
