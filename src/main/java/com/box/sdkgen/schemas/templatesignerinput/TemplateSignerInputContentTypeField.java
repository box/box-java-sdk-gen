...
public enum TemplateSignerInputContentTypeField {
  ...
  public static class TemplateSignerInputContentTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<TemplateSignerInputContentTypeField>> {
    ...
    @Override
    public EnumWrapper<TemplateSignerInputContentTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(TemplateSignerInputContentTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<TemplateSignerInputContentTypeField>(value, v)).orElse(new EnumWrapper<TemplateSignerInputContentTypeField>(value));
    }
  ...
  public static class TemplateSignerInputContentTypeFieldSerializer extends JsonSerializer<EnumWrapper<TemplateSignerInputContentTypeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<TemplateSignerInputContentTypeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
