...
public class TemplateSignerInput extends SignRequestPrefillTag {
  ...
  public int hashCode() {
    return Objects.hash(
      documentTagId, textValue, checkboxValue, dateValue, type, contentType, isRequired, pageIndex, documentId, dropdownChoices, groupId, coordinates, dimensions, label, readOnly
    );
  }

  @Override
  public String toString() {
    return "TemplateSignerInput{" + "documentTagId='" + documentTagId + '\'' + ", " + "textValue='" + textValue + '\'' + ", " + "checkboxValue='" + checkboxValue + '\'' + ", " + "dateValue='" + dateValue + '\'' + ", " + "type='" + type + '\'' + ", " + "contentType='" + contentType + '\'' + ", " + "isRequired='" + isRequired + '\'' + ", " + "pageIndex='" + pageIndex + '\'' + ", " + "documentId='" + documentId + '\'' + ", " + "dropdownChoices='" + dropdownChoices + '\'' + ", " + "groupId='" + groupId + '\'' + ", " + "coordinates='" + coordinates + '\'' + ", " + "dimensions='" + dimensions + '\'' + ", " + "label='" + label + '\'' + ", " + "readOnly='" + readOnly + '\'' + "}";
  }
  ...
  public static class TemplateSignerInputBuilder extends SignRequestPrefillTagBuilder {
    ...
    public TemplateSignerInputBuilder contentType(TemplateSignerInputContentTypeField contentType) {
      this.contentType = new EnumWrapper<TemplateSignerInputContentTypeField>(contentType.getValue(), contentType);
      return this;
    }
