...
public class WebLinkSharedLinkField {
  ...
  public WebLinkSharedLinkField(@JsonProperty("url") String url, @JsonProperty("effective_access") EnumWrapper<WebLinkSharedLinkEffectiveAccessField> effectiveAccess, @JsonProperty("effective_permission") EnumWrapper<WebLinkSharedLinkEffectivePermissionField> effectivePermission, @JsonProperty("is_password_enabled") boolean isPasswordEnabled, @JsonProperty("download_count") long downloadCount, @JsonProperty("preview_count") long previewCount) {
    this.url = url;
  ...
  public WebLinkSharedLinkField(String url, WebLinkSharedLinkEffectiveAccessField effectiveAccess, WebLinkSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
    this.url = url;
    this.effectiveAccess = new EnumWrapper<WebLinkSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
    this.effectivePermission = new EnumWrapper<WebLinkSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
    this.isPasswordEnabled = isPasswordEnabled;
    this.downloadCount = downloadCount;
    this.previewCount = previewCount;
  }
  ...
  public String toString() {
    return "WebLinkSharedLinkField{" + "url='" + url + '\'' + ", " + "downloadUrl='" + downloadUrl + '\'' + ", " + "vanityUrl='" + vanityUrl + '\'' + ", " + "vanityName='" + vanityName + '\'' + ", " + "access='" + access + '\'' + ", " + "effectiveAccess='" + effectiveAccess + '\'' + ", " + "effectivePermission='" + effectivePermission + '\'' + ", " + "unsharedAt='" + unsharedAt + '\'' + ", " + "isPasswordEnabled='" + isPasswordEnabled + '\'' + ", " + "permissions='" + permissions + '\'' + ", " + "downloadCount='" + downloadCount + '\'' + ", " + "previewCount='" + previewCount + '\'' + "}";
  }
  ...
  public static class WebLinkSharedLinkFieldBuilder {
    ...
    public WebLinkSharedLinkFieldBuilder(String url, WebLinkSharedLinkEffectiveAccessField effectiveAccess, WebLinkSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
      this.url = url;
      this.effectiveAccess = new EnumWrapper<WebLinkSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
      this.effectivePermission = new EnumWrapper<WebLinkSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
      this.isPasswordEnabled = isPasswordEnabled;
    ...
    public WebLinkSharedLinkFieldBuilder permissions(WebLinkSharedLinkPermissionsField permissions) {
