...
public class SearchResultsWithSharedLinks {
  ...
  public SearchResultsWithSharedLinks() {
    this.type = new EnumWrapper<SearchResultsWithSharedLinksTypeField>(SearchResultsWithSharedLinksTypeField.SEARCH_RESULTS_WITH_SHARED_LINKS.getValue(), SearchResultsWithSharedLinksTypeField.SEARCH_RESULTS_WITH_SHARED_LINKS);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      totalCount, limit, offset, type, entries
    );
  }

  @Override
  public String toString() {
    return "SearchResultsWithSharedLinks{" + "totalCount='" + totalCount + '\'' + ", " + "limit='" + limit + '\'' + ", " + "offset='" + offset + '\'' + ", " + "type='" + type + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
