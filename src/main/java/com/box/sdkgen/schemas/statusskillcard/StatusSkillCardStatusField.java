...
public class StatusSkillCardStatusField {
  ...
  public StatusSkillCardStatusField(@JsonProperty("code") EnumWrapper<StatusSkillCardStatusCodeField> code) {
    this.code = code;
  }
  ...
  public String toString() {
    return "StatusSkillCardStatusField{" + "code='" + code + '\'' + ", " + "message='" + message + '\'' + "}";
  }
