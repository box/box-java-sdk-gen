...
public class StatusSkillCardInvocationField {
  ...
  public StatusSkillCardInvocationField(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<StatusSkillCardInvocationTypeField>(StatusSkillCardInvocationTypeField.SKILL_INVOCATION.getValue(), StatusSkillCardInvocationTypeField.SKILL_INVOCATION);
  }
  ...
  public String toString() {
    return "StatusSkillCardInvocationField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
