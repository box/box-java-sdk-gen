...
public class StatusSkillCard {
  ...
  public StatusSkillCard(@JsonProperty("status") StatusSkillCardStatusField status, @JsonProperty("skill") StatusSkillCardSkillField skill, @JsonProperty("invocation") StatusSkillCardInvocationField invocation) {
    this.status = status;
    this.skill = skill;
    this.invocation = invocation;
    this.type = new EnumWrapper<StatusSkillCardTypeField>(StatusSkillCardTypeField.SKILL_CARD.getValue(), StatusSkillCardTypeField.SKILL_CARD);
    this.skillCardType = new EnumWrapper<StatusSkillCardSkillCardTypeField>(StatusSkillCardSkillCardTypeField.STATUS.getValue(), StatusSkillCardSkillCardTypeField.STATUS);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      createdAt, type, skillCardType, skillCardTitle, status, skill, invocation
    );
  }

  @Override
  public String toString() {
    return "StatusSkillCard{" + "createdAt='" + createdAt + '\'' + ", " + "type='" + type + '\'' + ", " + "skillCardType='" + skillCardType + '\'' + ", " + "skillCardTitle='" + skillCardTitle + '\'' + ", " + "status='" + status + '\'' + ", " + "skill='" + skill + '\'' + ", " + "invocation='" + invocation + '\'' + "}";
  }
  ...
  public static class StatusSkillCardBuilder {
    ...
    public StatusSkillCardBuilder(StatusSkillCardStatusField status, StatusSkillCardSkillField skill, StatusSkillCardInvocationField invocation) {
      this.status = status;
      this.skill = skill;
      this.invocation = invocation;
      this.type = new EnumWrapper<StatusSkillCardTypeField>(StatusSkillCardTypeField.SKILL_CARD.getValue(), StatusSkillCardTypeField.SKILL_CARD);
    ...
    public StatusSkillCardBuilder skillCardType(StatusSkillCardSkillCardTypeField skillCardType) {
      this.skillCardType = new EnumWrapper<StatusSkillCardSkillCardTypeField>(skillCardType.getValue(), skillCardType);
      return this;
    }

    public StatusSkillCardBuilder skillCardTitle(StatusSkillCardSkillCardTitleField skillCardTitle) {
