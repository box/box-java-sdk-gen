...
public class AiAgentBasicTextToolTextGen extends AiAgentBasicTextToolBase {
  ...
  public String toString() {
    return "AiAgentBasicTextToolTextGen{" + "model='" + model + '\'' + ", " + "numTokensForCompletion='" + numTokensForCompletion + '\'' + ", " + "llmEndpointParams='" + llmEndpointParams + '\'' + ", " + "systemMessage='" + systemMessage + '\'' + ", " + "promptTemplate='" + promptTemplate + '\'' + "}";
  }
  ...
  public static class AiAgentBasicTextToolTextGenBuilder extends AiAgentBasicTextToolBaseBuilder {
    ...
    @Override
    public AiAgentBasicTextToolTextGenBuilder llmEndpointParams(AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi llmEndpointParams) {
