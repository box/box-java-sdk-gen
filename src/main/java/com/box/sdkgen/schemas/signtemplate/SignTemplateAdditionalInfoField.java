...
public class SignTemplateAdditionalInfoField {
  ...
  public int hashCode() {
    return Objects.hash(
      nonEditable, required
    );
  }

  @Override
  public String toString() {
    return "SignTemplateAdditionalInfoField{" + "nonEditable='" + nonEditable + '\'' + ", " + "required='" + required + '\'' + "}";
  }
  ...
  public static class SignTemplateAdditionalInfoFieldBuilder {
    ...
    public SignTemplateAdditionalInfoFieldBuilder nonEditable(List<SignTemplateAdditionalInfoNonEditableField> nonEditable) {
      this.nonEditable = nonEditable;
      return this;
    }

    public SignTemplateAdditionalInfoFieldBuilder required(SignTemplateAdditionalInfoRequiredField required) {
