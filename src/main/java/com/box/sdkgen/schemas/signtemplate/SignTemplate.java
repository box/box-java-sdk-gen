...
public class SignTemplate {
  ...
  public int hashCode() {
    return Objects.hash(
      type, id, name, emailSubject, emailMessage, daysValid, parentFolder, sourceFiles, areFieldsLocked, areOptionsLocked, areRecipientsLocked, areEmailSettingsLocked, areFilesLocked, signers, additionalInfo, readySignLink, customBranding
    );
  }

  @Override
  public String toString() {
    return "SignTemplate{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + ", " + "name='" + name + '\'' + ", " + "emailSubject='" + emailSubject + '\'' + ", " + "emailMessage='" + emailMessage + '\'' + ", " + "daysValid='" + daysValid + '\'' + ", " + "parentFolder='" + parentFolder + '\'' + ", " + "sourceFiles='" + sourceFiles + '\'' + ", " + "areFieldsLocked='" + areFieldsLocked + '\'' + ", " + "areOptionsLocked='" + areOptionsLocked + '\'' + ", " + "areRecipientsLocked='" + areRecipientsLocked + '\'' + ", " + "areEmailSettingsLocked='" + areEmailSettingsLocked + '\'' + ", " + "areFilesLocked='" + areFilesLocked + '\'' + ", " + "signers='" + signers + '\'' + ", " + "additionalInfo='" + additionalInfo + '\'' + ", " + "readySignLink='" + readySignLink + '\'' + ", " + "customBranding='" + customBranding + '\'' + "}";
  }
