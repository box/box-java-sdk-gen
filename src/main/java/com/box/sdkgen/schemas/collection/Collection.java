...
public class Collection {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, name, collectionType
    );
  }

  @Override
  public String toString() {
    return "Collection{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "name='" + name + '\'' + ", " + "collectionType='" + collectionType + '\'' + "}";
  }
  ...
  public static class CollectionBuilder {
    ...
    public CollectionBuilder collectionType(CollectionCollectionTypeField collectionType) {
      this.collectionType = new EnumWrapper<CollectionCollectionTypeField>(collectionType.getValue(), collectionType);
      return this;
    }
