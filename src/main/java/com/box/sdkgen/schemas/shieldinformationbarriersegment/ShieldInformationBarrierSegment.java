...
public class ShieldInformationBarrierSegment {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, shieldInformationBarrier, name, description, createdAt, createdBy, updatedAt, updatedBy
    );
  }

  @Override
  public String toString() {
    return "ShieldInformationBarrierSegment{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + ", " + "name='" + name + '\'' + ", " + "description='" + description + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + ", " + "updatedBy='" + updatedBy + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierSegmentBuilder {
    ...
    public ShieldInformationBarrierSegmentBuilder type(ShieldInformationBarrierSegmentTypeField type) {
      this.type = new EnumWrapper<ShieldInformationBarrierSegmentTypeField>(type.getValue(), type);
      return this;
    }

    public ShieldInformationBarrierSegmentBuilder shieldInformationBarrier(ShieldInformationBarrierBase shieldInformationBarrier) {
