...
public class SignRequestSigner extends SignRequestCreateSigner {
  ...
  public int hashCode() {
    return Objects.hash(
      email, role, isInPerson, order, embedUrlExternalUserId, redirectUrl, declinedRedirectUrl, loginRequired, verificationPhoneNumber, password, signerGroupId, suppressNotifications, hasViewedDocument, signerDecision, inputs, embedUrl, iframeableEmbedUrl
    );
  }

  @Override
  public String toString() {
    return "SignRequestSigner{" + "email='" + email + '\'' + ", " + "role='" + role + '\'' + ", " + "isInPerson='" + isInPerson + '\'' + ", " + "order='" + order + '\'' + ", " + "embedUrlExternalUserId='" + embedUrlExternalUserId + '\'' + ", " + "redirectUrl='" + redirectUrl + '\'' + ", " + "declinedRedirectUrl='" + declinedRedirectUrl + '\'' + ", " + "loginRequired='" + loginRequired + '\'' + ", " + "verificationPhoneNumber='" + verificationPhoneNumber + '\'' + ", " + "password='" + password + '\'' + ", " + "signerGroupId='" + signerGroupId + '\'' + ", " + "suppressNotifications='" + suppressNotifications + '\'' + ", " + "hasViewedDocument='" + hasViewedDocument + '\'' + ", " + "signerDecision='" + signerDecision + '\'' + ", " + "inputs='" + inputs + '\'' + ", " + "embedUrl='" + embedUrl + '\'' + ", " + "iframeableEmbedUrl='" + iframeableEmbedUrl + '\'' + "}";
  }
  ...
  public static class SignRequestSignerBuilder extends SignRequestCreateSignerBuilder {
    ...
    public SignRequestSignerBuilder signerDecision(SignRequestSignerSignerDecisionField signerDecision) {
