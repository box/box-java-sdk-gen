...
public class FileSharedLinkField {
  ...
  @JsonDeserialize(using = FileSharedLinkEffectiveAccessField.FileSharedLinkEffectiveAccessFieldDeserializer.class)
  @JsonSerialize(using = FileSharedLinkEffectiveAccessField.FileSharedLinkEffectiveAccessFieldSerializer.class)
  @JsonProperty("effective_access")
  protected final EnumWrapper<FileSharedLinkEffectiveAccessField> effectiveAccess;

  @JsonDeserialize(using = FileSharedLinkEffectivePermissionField.FileSharedLinkEffectivePermissionFieldDeserializer.class)
  @JsonSerialize(using = FileSharedLinkEffectivePermissionField.FileSharedLinkEffectivePermissionFieldSerializer.class)
  ...
  public FileSharedLinkField(@JsonProperty("url") String url, @JsonProperty("effective_access") EnumWrapper<FileSharedLinkEffectiveAccessField> effectiveAccess, @JsonProperty("effective_permission") EnumWrapper<FileSharedLinkEffectivePermissionField> effectivePermission, @JsonProperty("is_password_enabled") boolean isPasswordEnabled, @JsonProperty("download_count") long downloadCount, @JsonProperty("preview_count") long previewCount) {
    this.url = url;
  ...
  public FileSharedLinkField(String url, FileSharedLinkEffectiveAccessField effectiveAccess, FileSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
    this.url = url;
    this.effectiveAccess = new EnumWrapper<FileSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
    this.effectivePermission = new EnumWrapper<FileSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
    this.isPasswordEnabled = isPasswordEnabled;
    this.downloadCount = downloadCount;
    this.previewCount = previewCount;
  }
  ...
  public int hashCode() {
    return Objects.hash(
      url, downloadUrl, vanityUrl, vanityName, access, effectiveAccess, effectivePermission, unsharedAt, isPasswordEnabled, permissions, downloadCount, previewCount
    );
  }

  @Override
  public String toString() {
    return "FileSharedLinkField{" + "url='" + url + '\'' + ", " + "downloadUrl='" + downloadUrl + '\'' + ", " + "vanityUrl='" + vanityUrl + '\'' + ", " + "vanityName='" + vanityName + '\'' + ", " + "access='" + access + '\'' + ", " + "effectiveAccess='" + effectiveAccess + '\'' + ", " + "effectivePermission='" + effectivePermission + '\'' + ", " + "unsharedAt='" + unsharedAt + '\'' + ", " + "isPasswordEnabled='" + isPasswordEnabled + '\'' + ", " + "permissions='" + permissions + '\'' + ", " + "downloadCount='" + downloadCount + '\'' + ", " + "previewCount='" + previewCount + '\'' + "}";
  }
  ...
  public static class FileSharedLinkFieldBuilder {
    ...
    public FileSharedLinkFieldBuilder(String url, FileSharedLinkEffectiveAccessField effectiveAccess, FileSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
      this.url = url;
      this.effectiveAccess = new EnumWrapper<FileSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
      this.effectivePermission = new EnumWrapper<FileSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
      this.isPasswordEnabled = isPasswordEnabled;
