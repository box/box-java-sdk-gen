...
public class Classification {
  ...
  public String toString() {
    return "Classification{" + "boxSecurityClassificationKey='" + boxSecurityClassificationKey + '\'' + ", " + "parent='" + parent + '\'' + ", " + "template='" + template + '\'' + ", " + "scope='" + scope + '\'' + ", " + "version='" + version + '\'' + ", " + "type='" + type + '\'' + ", " + "typeVersion='" + typeVersion + '\'' + ", " + "canEdit='" + canEdit + '\'' + "}";
  }
