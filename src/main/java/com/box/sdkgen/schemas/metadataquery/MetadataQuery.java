...
public class MetadataQuery {
  ...
  public MetadataQuery(@JsonProperty("from") String from, @JsonProperty("ancestor_folder_id") String ancestorFolderId) {
    this.from = from;
  ...
  public int hashCode() {
    return Objects.hash(
      from, query, queryParams, ancestorFolderId, orderBy, limit, marker, fields
    );
  }

  @Override
  public String toString() {
    return "MetadataQuery{" + "from='" + from + '\'' + ", " + "query='" + query + '\'' + ", " + "queryParams='" + queryParams + '\'' + ", " + "ancestorFolderId='" + ancestorFolderId + '\'' + ", " + "orderBy='" + orderBy + '\'' + ", " + "limit='" + limit + '\'' + ", " + "marker='" + marker + '\'' + ", " + "fields='" + fields + '\'' + "}";
  }
