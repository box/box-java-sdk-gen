...
public class AiAgentAsk {
  ...
  public AiAgentAsk() {
    this.type = new EnumWrapper<AiAgentAskTypeField>(AiAgentAskTypeField.AI_AGENT_ASK.getValue(), AiAgentAskTypeField.AI_AGENT_ASK);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      type, longText, basicText, longTextMulti, basicTextMulti
    );
  }

  @Override
  public String toString() {
    return "AiAgentAsk{" + "type='" + type + '\'' + ", " + "longText='" + longText + '\'' + ", " + "basicText='" + basicText + '\'' + ", " + "longTextMulti='" + longTextMulti + '\'' + ", " + "basicTextMulti='" + basicTextMulti + '\'' + "}";
  }
