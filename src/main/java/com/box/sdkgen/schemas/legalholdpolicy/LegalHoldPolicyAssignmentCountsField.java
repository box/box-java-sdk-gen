...
public class LegalHoldPolicyAssignmentCountsField {
  ...
  protected LegalHoldPolicyAssignmentCountsField(LegalHoldPolicyAssignmentCountsFieldBuilder builder) {
  ...
  public String toString() {
    return "LegalHoldPolicyAssignmentCountsField{" + "user='" + user + '\'' + ", " + "folder='" + folder + '\'' + ", " + "file='" + file + '\'' + ", " + "fileVersion='" + fileVersion + '\'' + "}";
  }
