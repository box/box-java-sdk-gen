...
public class LegalHoldPolicy extends LegalHoldPolicyMini {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, policyName, description, status, assignmentCounts, createdBy, createdAt, modifiedAt, deletedAt, filterStartedAt, filterEndedAt, releaseNotes
    );
  }

  @Override
  public String toString() {
    return "LegalHoldPolicy{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "policyName='" + policyName + '\'' + ", " + "description='" + description + '\'' + ", " + "status='" + status + '\'' + ", " + "assignmentCounts='" + assignmentCounts + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "deletedAt='" + deletedAt + '\'' + ", " + "filterStartedAt='" + filterStartedAt + '\'' + ", " + "filterEndedAt='" + filterEndedAt + '\'' + ", " + "releaseNotes='" + releaseNotes + '\'' + "}";
  }
  ...
  public static class LegalHoldPolicyBuilder extends LegalHoldPolicyMiniBuilder {
    ...
    public LegalHoldPolicyBuilder assignmentCounts(LegalHoldPolicyAssignmentCountsField assignmentCounts) {
