...
public class TermsOfService extends TermsOfServiceBase {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, status, enterprise, tosType, text, createdAt, modifiedAt
    );
  }

  @Override
  public String toString() {
    return "TermsOfService{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "status='" + status + '\'' + ", " + "enterprise='" + enterprise + '\'' + ", " + "tosType='" + tosType + '\'' + ", " + "text='" + text + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + "}";
  }
