...
public class SkillInvocationTokenWriteField {
  ...
  public int hashCode() {
    return Objects.hash(
      accessToken, expiresIn, tokenType, restrictedTo
    );
  }

  @Override
  public String toString() {
    return "SkillInvocationTokenWriteField{" + "accessToken='" + accessToken + '\'' + ", " + "expiresIn='" + expiresIn + '\'' + ", " + "tokenType='" + tokenType + '\'' + ", " + "restrictedTo='" + restrictedTo + '\'' + "}";
  }
  ...
  public static class SkillInvocationTokenWriteFieldBuilder {
    ...
    public SkillInvocationTokenWriteFieldBuilder tokenType(SkillInvocationTokenWriteTokenTypeField tokenType) {
      this.tokenType = new EnumWrapper<SkillInvocationTokenWriteTokenTypeField>(tokenType.getValue(), tokenType);
      return this;
    }
