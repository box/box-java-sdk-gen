...
public class SkillInvocationTokenReadField {
  ...
  public String toString() {
    return "SkillInvocationTokenReadField{" + "accessToken='" + accessToken + '\'' + ", " + "expiresIn='" + expiresIn + '\'' + ", " + "tokenType='" + tokenType + '\'' + ", " + "restrictedTo='" + restrictedTo + '\'' + "}";
  }
  ...
  public static class SkillInvocationTokenReadFieldBuilder {
    ...
    public SkillInvocationTokenReadFieldBuilder tokenType(SkillInvocationTokenReadTokenTypeField tokenType) {
      this.tokenType = new EnumWrapper<SkillInvocationTokenReadTokenTypeField>(tokenType.getValue(), tokenType);
      return this;
    }
