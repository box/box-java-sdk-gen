...
public class SkillInvocation {
  ...
  public String toString() {
    return "SkillInvocation{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + ", " + "skill='" + skill + '\'' + ", " + "token='" + token + '\'' + ", " + "status='" + status + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "trigger='" + trigger + '\'' + ", " + "enterprise='" + enterprise + '\'' + ", " + "source='" + source + '\'' + ", " + "event='" + event + '\'' + "}";
  }
