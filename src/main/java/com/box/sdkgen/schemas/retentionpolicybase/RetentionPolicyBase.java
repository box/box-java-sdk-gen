...
public class RetentionPolicyBase {
  ...
  public RetentionPolicyBase(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<RetentionPolicyBaseTypeField>(RetentionPolicyBaseTypeField.RETENTION_POLICY.getValue(), RetentionPolicyBaseTypeField.RETENTION_POLICY);
  }
