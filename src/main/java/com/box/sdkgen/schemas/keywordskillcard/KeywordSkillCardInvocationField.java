...
public class KeywordSkillCardInvocationField {
  ...
  public KeywordSkillCardInvocationField(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<KeywordSkillCardInvocationTypeField>(KeywordSkillCardInvocationTypeField.SKILL_INVOCATION.getValue(), KeywordSkillCardInvocationTypeField.SKILL_INVOCATION);
  }
  ...
  public String toString() {
    return "KeywordSkillCardInvocationField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
