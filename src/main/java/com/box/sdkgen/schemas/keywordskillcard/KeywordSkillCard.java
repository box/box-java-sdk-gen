...
public class KeywordSkillCard {
  ...
  public KeywordSkillCard(@JsonProperty("skill") KeywordSkillCardSkillField skill, @JsonProperty("invocation") KeywordSkillCardInvocationField invocation, @JsonProperty("entries") List<KeywordSkillCardEntriesField> entries) {
    this.skill = skill;
    this.invocation = invocation;
    this.entries = entries;
    this.type = new EnumWrapper<KeywordSkillCardTypeField>(KeywordSkillCardTypeField.SKILL_CARD.getValue(), KeywordSkillCardTypeField.SKILL_CARD);
    this.skillCardType = new EnumWrapper<KeywordSkillCardSkillCardTypeField>(KeywordSkillCardSkillCardTypeField.KEYWORD.getValue(), KeywordSkillCardSkillCardTypeField.KEYWORD);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      createdAt, type, skillCardType, skillCardTitle, skill, invocation, entries
    );
  }

  @Override
  public String toString() {
    return "KeywordSkillCard{" + "createdAt='" + createdAt + '\'' + ", " + "type='" + type + '\'' + ", " + "skillCardType='" + skillCardType + '\'' + ", " + "skillCardTitle='" + skillCardTitle + '\'' + ", " + "skill='" + skill + '\'' + ", " + "invocation='" + invocation + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class KeywordSkillCardBuilder {
    ...
    public KeywordSkillCardBuilder(KeywordSkillCardSkillField skill, KeywordSkillCardInvocationField invocation, List<KeywordSkillCardEntriesField> entries) {
      this.skill = skill;
      this.invocation = invocation;
      this.entries = entries;
      this.type = new EnumWrapper<KeywordSkillCardTypeField>(KeywordSkillCardTypeField.SKILL_CARD.getValue(), KeywordSkillCardTypeField.SKILL_CARD);
    ...
    public KeywordSkillCardBuilder skillCardType(KeywordSkillCardSkillCardTypeField skillCardType) {
      this.skillCardType = new EnumWrapper<KeywordSkillCardSkillCardTypeField>(skillCardType.getValue(), skillCardType);
      return this;
    }

    public KeywordSkillCardBuilder skillCardTitle(KeywordSkillCardSkillCardTitleField skillCardTitle) {
