...
public class TrashFilePathCollectionField {
  ...
  public TrashFilePathCollectionField(@JsonProperty("total_count") long totalCount, @JsonProperty("entries") List<TrashFilePathCollectionEntriesField> entries) {
  ...
  public String toString() {
    return "TrashFilePathCollectionField{" + "totalCount='" + totalCount + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
