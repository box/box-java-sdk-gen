...
public class TrashFile {
  ...
  public TrashFile(@JsonProperty("id") String id, @JsonProperty("sequence_id") String sequenceId, @JsonProperty("sha1") String sha1, @JsonProperty("description") String description, @JsonProperty("size") long size, @JsonProperty("path_collection") TrashFilePathCollectionField pathCollection, @JsonProperty("created_at") String createdAt, @JsonProperty("modified_at") String modifiedAt, @JsonProperty("modified_by") UserMini modifiedBy, @JsonProperty("owned_by") UserMini ownedBy, @JsonProperty("item_status") EnumWrapper<TrashFileItemStatusField> itemStatus) {
    this.id = id;
    ...
    this.type = new EnumWrapper<TrashFileTypeField>(TrashFileTypeField.FILE.getValue(), TrashFileTypeField.FILE);
  }

  public TrashFile(String id, String sequenceId, String sha1, String description, long size, TrashFilePathCollectionField pathCollection, String createdAt, String modifiedAt, UserMini modifiedBy, UserMini ownedBy, TrashFileItemStatusField itemStatus) {
    this.id = id;
    this.sequenceId = sequenceId;
    this.sha1 = sha1;
    this.description = description;
  ...
  public static class TrashFileBuilder {
    ...
    public TrashFileBuilder(String id, String sequenceId, String sha1, String description, long size, TrashFilePathCollectionField pathCollection, String createdAt, String modifiedAt, UserMini modifiedBy, UserMini ownedBy, TrashFileItemStatusField itemStatus) {
      this.id = id;
      this.sequenceId = sequenceId;
      this.sha1 = sha1;
      this.description = description;
