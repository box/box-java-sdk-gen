...
public class UploadSession {
  ...
  public String toString() {
    return "UploadSession{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "sessionExpiresAt='" + sessionExpiresAt + '\'' + ", " + "partSize='" + partSize + '\'' + ", " + "totalParts='" + totalParts + '\'' + ", " + "numPartsProcessed='" + numPartsProcessed + '\'' + ", " + "sessionEndpoints='" + sessionEndpoints + '\'' + "}";
  }
  ...
  public static class UploadSessionBuilder {
    ...
    public UploadSessionBuilder sessionEndpoints(UploadSessionSessionEndpointsField sessionEndpoints) {
