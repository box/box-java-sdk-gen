...
public class WebhookInvocation {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, webhook, createdBy, createdAt, trigger, source
    );
  }

  @Override
  public String toString() {
    return "WebhookInvocation{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "webhook='" + webhook + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "trigger='" + trigger + '\'' + ", " + "source='" + source + '\'' + "}";
  }
