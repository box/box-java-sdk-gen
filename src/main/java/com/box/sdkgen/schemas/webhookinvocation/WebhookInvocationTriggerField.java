...
public enum WebhookInvocationTriggerField {
  ...
  public static class WebhookInvocationTriggerFieldDeserializer extends JsonDeserializer<EnumWrapper<WebhookInvocationTriggerField>> {
    ...
    @Override
    public EnumWrapper<WebhookInvocationTriggerField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(WebhookInvocationTriggerField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<WebhookInvocationTriggerField>(value, v)).orElse(new EnumWrapper<WebhookInvocationTriggerField>(value));
    }

  }

  public static class WebhookInvocationTriggerFieldSerializer extends JsonSerializer<EnumWrapper<WebhookInvocationTriggerField>> {
    ...
    @Override
    public void serialize(EnumWrapper<WebhookInvocationTriggerField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
