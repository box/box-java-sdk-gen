...
public enum WebhookInvocationTriggerField {
  ...
  public static class WebhookInvocationTriggerFieldDeserializer
      extends JsonDeserializer<EnumWrapper<WebhookInvocationTriggerField>> {
    ...
    @Override
    public EnumWrapper<WebhookInvocationTriggerField> deserialize(
  ...
  public static class WebhookInvocationTriggerFieldSerializer
      extends JsonSerializer<EnumWrapper<WebhookInvocationTriggerField>> {
    ...
    public void serialize(
        EnumWrapper<WebhookInvocationTriggerField> value,
        JsonGenerator gen,
