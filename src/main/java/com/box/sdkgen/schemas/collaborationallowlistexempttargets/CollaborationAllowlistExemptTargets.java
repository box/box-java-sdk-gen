...
public class CollaborationAllowlistExemptTargets {
  ...
  protected CollaborationAllowlistExemptTargets(CollaborationAllowlistExemptTargetsBuilder builder) {
  ...
  public String toString() {
    return "CollaborationAllowlistExemptTargets{" + "limit='" + limit + '\'' + ", " + "nextMarker='" + nextMarker + '\'' + ", " + "prevMarker='" + prevMarker + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class CollaborationAllowlistExemptTargetsBuilder {
    ...
    public CollaborationAllowlistExemptTargetsBuilder entries(List<CollaborationAllowlistExemptTarget> entries) {
