...
public class TrashFileRestored {
  ...
  public TrashFileRestored(@JsonProperty("id") String id, @JsonProperty("sequence_id") String sequenceId, @JsonProperty("sha1") String sha1, @JsonProperty("description") String description, @JsonProperty("size") long size, @JsonProperty("path_collection") TrashFileRestoredPathCollectionField pathCollection, @JsonProperty("created_at") String createdAt, @JsonProperty("modified_at") String modifiedAt, @JsonProperty("modified_by") UserMini modifiedBy, @JsonProperty("owned_by") UserMini ownedBy, @JsonProperty("item_status") EnumWrapper<TrashFileRestoredItemStatusField> itemStatus) {
    this.id = id;
    ...
    this.type = new EnumWrapper<TrashFileRestoredTypeField>(TrashFileRestoredTypeField.FILE.getValue(), TrashFileRestoredTypeField.FILE);
  }

  public TrashFileRestored(String id, String sequenceId, String sha1, String description, long size, TrashFileRestoredPathCollectionField pathCollection, String createdAt, String modifiedAt, UserMini modifiedBy, UserMini ownedBy, TrashFileRestoredItemStatusField itemStatus) {
    this.id = id;
    this.sequenceId = sequenceId;
    this.sha1 = sha1;
    this.description = description;
    ...
    this.modifiedBy = modifiedBy;
    this.ownedBy = ownedBy;
    this.itemStatus = new EnumWrapper<TrashFileRestoredItemStatusField>(itemStatus.getValue(), itemStatus);
    this.type = new EnumWrapper<TrashFileRestoredTypeField>(TrashFileRestoredTypeField.FILE.getValue(), TrashFileRestoredTypeField.FILE);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, etag, type, sequenceId, name, sha1, fileVersion, description, size, pathCollection, createdAt, modifiedAt, trashedAt, purgedAt, contentCreatedAt, contentModifiedAt, createdBy, modifiedBy, ownedBy, sharedLink, parent, itemStatus
    );
  }

  @Override
  public String toString() {
    return "TrashFileRestored{" + "id='" + id + '\'' + ", " + "etag='" + etag + '\'' + ", " + "type='" + type + '\'' + ", " + "sequenceId='" + sequenceId + '\'' + ", " + "name='" + name + '\'' + ", " + "sha1='" + sha1 + '\'' + ", " + "fileVersion='" + fileVersion + '\'' + ", " + "description='" + description + '\'' + ", " + "size='" + size + '\'' + ", " + "pathCollection='" + pathCollection + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "trashedAt='" + trashedAt + '\'' + ", " + "purgedAt='" + purgedAt + '\'' + ", " + "contentCreatedAt='" + contentCreatedAt + '\'' + ", " + "contentModifiedAt='" + contentModifiedAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "modifiedBy='" + modifiedBy + '\'' + ", " + "ownedBy='" + ownedBy + '\'' + ", " + "sharedLink='" + sharedLink + '\'' + ", " + "parent='" + parent + '\'' + ", " + "itemStatus='" + itemStatus + '\'' + "}";
  }
  ...
  public static class TrashFileRestoredBuilder {
    ...
    public TrashFileRestoredBuilder(String id, String sequenceId, String sha1, String description, long size, TrashFileRestoredPathCollectionField pathCollection, String createdAt, String modifiedAt, UserMini modifiedBy, UserMini ownedBy, TrashFileRestoredItemStatusField itemStatus) {
      this.id = id;
      this.sequenceId = sequenceId;
      this.sha1 = sha1;
      this.description = description;
