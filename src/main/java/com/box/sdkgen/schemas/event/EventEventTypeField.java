...
public enum EventEventTypeField {
  ...
  public static class EventEventTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<EventEventTypeField>> {
    ...
    @Override
    public EnumWrapper<EventEventTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(EventEventTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<EventEventTypeField>(value, v)).orElse(new EnumWrapper<EventEventTypeField>(value));
    }

  }

  public static class EventEventTypeFieldSerializer extends JsonSerializer<EnumWrapper<EventEventTypeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<EventEventTypeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
