...
public class Event {
  ...
  public int hashCode() {
    return Objects.hash(
      type, createdAt, recordedAt, eventId, createdBy, eventType, sessionId, source, additionalDetails
    );
  }

  @Override
  public String toString() {
    return "Event{" + "type='" + type + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "recordedAt='" + recordedAt + '\'' + ", " + "eventId='" + eventId + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "eventType='" + eventType + '\'' + ", " + "sessionId='" + sessionId + '\'' + ", " + "source='" + source + '\'' + ", " + "additionalDetails='" + additionalDetails + '\'' + "}";
  }
  ...
  public static class EventBuilder {
    ...
    public EventBuilder source(AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser source) {
      this.source = source;
      return this;
    }
