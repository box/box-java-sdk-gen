...
public class TaskAssignment {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, item, assignedTo, message, completedAt, assignedAt, remindedAt, resolutionState, assignedBy
    );
  }

  @Override
  public String toString() {
    return "TaskAssignment{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "item='" + item + '\'' + ", " + "assignedTo='" + assignedTo + '\'' + ", " + "message='" + message + '\'' + ", " + "completedAt='" + completedAt + '\'' + ", " + "assignedAt='" + assignedAt + '\'' + ", " + "remindedAt='" + remindedAt + '\'' + ", " + "resolutionState='" + resolutionState + '\'' + ", " + "assignedBy='" + assignedBy + '\'' + "}";
  }
  ...
  public static class TaskAssignmentBuilder {
    ...
    public TaskAssignmentBuilder resolutionState(TaskAssignmentResolutionStateField resolutionState) {
      this.resolutionState = new EnumWrapper<TaskAssignmentResolutionStateField>(resolutionState.getValue(), resolutionState);
      return this;
    }
