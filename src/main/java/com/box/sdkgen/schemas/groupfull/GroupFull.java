...
public class GroupFull extends Group {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, name, groupType, createdAt, modifiedAt, provenance, externalSyncIdentifier, description, invitabilityLevel, memberViewabilityLevel, permissions
    );
  }

  @Override
  public String toString() {
    return "GroupFull{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "name='" + name + '\'' + ", " + "groupType='" + groupType + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "provenance='" + provenance + '\'' + ", " + "externalSyncIdentifier='" + externalSyncIdentifier + '\'' + ", " + "description='" + description + '\'' + ", " + "invitabilityLevel='" + invitabilityLevel + '\'' + ", " + "memberViewabilityLevel='" + memberViewabilityLevel + '\'' + ", " + "permissions='" + permissions + '\'' + "}";
  }
  ...
  public static class GroupFullBuilder extends GroupBuilder {
    ...
    public GroupFullBuilder invitabilityLevel(GroupFullInvitabilityLevelField invitabilityLevel) {
      this.invitabilityLevel = new EnumWrapper<GroupFullInvitabilityLevelField>(invitabilityLevel.getValue(), invitabilityLevel);
      return this;
    }

    public GroupFullBuilder memberViewabilityLevel(GroupFullMemberViewabilityLevelField memberViewabilityLevel) {
      this.memberViewabilityLevel = new EnumWrapper<GroupFullMemberViewabilityLevelField>(memberViewabilityLevel.getValue(), memberViewabilityLevel);
      return this;
    }
