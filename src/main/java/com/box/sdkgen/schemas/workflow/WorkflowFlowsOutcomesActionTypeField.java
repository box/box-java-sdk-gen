...
public enum WorkflowFlowsOutcomesActionTypeField {
  ...
  public static class WorkflowFlowsOutcomesActionTypeFieldDeserializer extends JsonDeserializer<EnumWrapper<WorkflowFlowsOutcomesActionTypeField>> {
    ...
    @Override
    public EnumWrapper<WorkflowFlowsOutcomesActionTypeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(WorkflowFlowsOutcomesActionTypeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<WorkflowFlowsOutcomesActionTypeField>(value, v)).orElse(new EnumWrapper<WorkflowFlowsOutcomesActionTypeField>(value));
    }
  ...
  public static class WorkflowFlowsOutcomesActionTypeFieldSerializer extends JsonSerializer<EnumWrapper<WorkflowFlowsOutcomesActionTypeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<WorkflowFlowsOutcomesActionTypeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
