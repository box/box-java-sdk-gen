...
public class WorkflowFlowsField {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, trigger, outcomes, createdAt, createdBy
    );
  }

  @Override
  public String toString() {
    return "WorkflowFlowsField{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "trigger='" + trigger + '\'' + ", " + "outcomes='" + outcomes + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + "}";
  }
