...
public class ShieldInformationBarrierSegmentMember extends ShieldInformationBarrierSegmentMemberMini {
  ...
  protected ShieldInformationBarrierSegmentMember(ShieldInformationBarrierSegmentMemberBuilder builder) {
    super(builder);
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, user, shieldInformationBarrier, shieldInformationBarrierSegment, createdAt, createdBy, updatedAt, updatedBy
    );
  }

  @Override
  public String toString() {
    return "ShieldInformationBarrierSegmentMember{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "user='" + user + '\'' + ", " + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + ", " + "shieldInformationBarrierSegment='" + shieldInformationBarrierSegment + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + ", " + "updatedBy='" + updatedBy + '\'' + "}";
  }

  public static class ShieldInformationBarrierSegmentMemberBuilder extends ShieldInformationBarrierSegmentMemberMiniBuilder {
    ...
    public ShieldInformationBarrierSegmentMemberBuilder shieldInformationBarrier(ShieldInformationBarrierBase shieldInformationBarrier) {
      this.shieldInformationBarrier = shieldInformationBarrier;
      return this;
    }

    public ShieldInformationBarrierSegmentMemberBuilder shieldInformationBarrierSegment(ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField shieldInformationBarrierSegment) {
    ...
    @Override
    public ShieldInformationBarrierSegmentMemberBuilder type(ShieldInformationBarrierSegmentMemberBaseTypeField type) {
