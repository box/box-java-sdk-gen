...
public class CollaborationsOrderField {
  ...
  @JsonDeserialize(using = CollaborationsOrderDirectionField.CollaborationsOrderDirectionFieldDeserializer.class)
  @JsonSerialize(using = CollaborationsOrderDirectionField.CollaborationsOrderDirectionFieldSerializer.class)
  ...
  public String toString() {
    return "CollaborationsOrderField{" + "by='" + by + '\'' + ", " + "direction='" + direction + '\'' + "}";
  }
  ...
  public static class CollaborationsOrderFieldBuilder {
    ...
    public CollaborationsOrderFieldBuilder direction(CollaborationsOrderDirectionField direction) {
      this.direction = new EnumWrapper<CollaborationsOrderDirectionField>(direction.getValue(), direction);
      return this;
    }
