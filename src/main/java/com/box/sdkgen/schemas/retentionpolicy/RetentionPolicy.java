...
public class RetentionPolicy extends RetentionPolicyMini {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, policyName, retentionLength, dispositionAction, description, policyType, retentionType, status, createdBy, createdAt, modifiedAt, canOwnerExtendRetention, areOwnersNotified, customNotificationRecipients, assignmentCounts
    );
  }

  @Override
  public String toString() {
    return "RetentionPolicy{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "policyName='" + policyName + '\'' + ", " + "retentionLength='" + retentionLength + '\'' + ", " + "dispositionAction='" + dispositionAction + '\'' + ", " + "description='" + description + '\'' + ", " + "policyType='" + policyType + '\'' + ", " + "retentionType='" + retentionType + '\'' + ", " + "status='" + status + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "canOwnerExtendRetention='" + canOwnerExtendRetention + '\'' + ", " + "areOwnersNotified='" + areOwnersNotified + '\'' + ", " + "customNotificationRecipients='" + customNotificationRecipients + '\'' + ", " + "assignmentCounts='" + assignmentCounts + '\'' + "}";
  }
  ...
  public static class RetentionPolicyBuilder extends RetentionPolicyMiniBuilder {
    ...
    public RetentionPolicyBuilder policyType(RetentionPolicyPolicyTypeField policyType) {
      this.policyType = new EnumWrapper<RetentionPolicyPolicyTypeField>(policyType.getValue(), policyType);
      return this;
    }

    public RetentionPolicyBuilder retentionType(RetentionPolicyRetentionTypeField retentionType) {
      this.retentionType = new EnumWrapper<RetentionPolicyRetentionTypeField>(retentionType.getValue(), retentionType);
      return this;
    }
    ...
    public RetentionPolicyBuilder customNotificationRecipients(List<UserMini> customNotificationRecipients) {
      this.customNotificationRecipients = customNotificationRecipients;
      return this;
    }

    public RetentionPolicyBuilder assignmentCounts(RetentionPolicyAssignmentCountsField assignmentCounts) {
    ...
    @Override
    public RetentionPolicyBuilder dispositionAction(RetentionPolicyMiniDispositionActionField dispositionAction) {
      this.dispositionAction = new EnumWrapper<RetentionPolicyMiniDispositionActionField>(dispositionAction.getValue(), dispositionAction);
      return this;
    }
