...
public class IntegrationMappingSlackOptions {
  ...
  public String toString() {
    return "IntegrationMappingSlackOptions{" + "isAccessManagementDisabled='" + isAccessManagementDisabled + '\'' + "}";
  }
  ...
  public static class IntegrationMappingSlackOptionsBuilder {
    ...
    public IntegrationMappingSlackOptionsBuilder isAccessManagementDisabled(Boolean isAccessManagementDisabled) {
