...
public class ShieldInformationBarrierSegmentRestrictionMini extends ShieldInformationBarrierSegmentRestrictionBase {
  ...
  protected ShieldInformationBarrierSegmentRestrictionMini(ShieldInformationBarrierSegmentRestrictionMiniBuilder builder) {
    super(builder);
  ...
  public boolean equals(Object o) {
    ...
    ShieldInformationBarrierSegmentRestrictionMini casted = (ShieldInformationBarrierSegmentRestrictionMini) o;
  ...
  public int hashCode() {
    return Objects.hash(
      type, id, shieldInformationBarrierSegment, restrictedSegment
    );
  }

  @Override
  public String toString() {
    return "ShieldInformationBarrierSegmentRestrictionMini{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + ", " + "shieldInformationBarrierSegment='" + shieldInformationBarrierSegment + '\'' + ", " + "restrictedSegment='" + restrictedSegment + '\'' + "}";
  }

  public static class ShieldInformationBarrierSegmentRestrictionMiniBuilder extends ShieldInformationBarrierSegmentRestrictionBaseBuilder {

    protected final ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField shieldInformationBarrierSegment;

    protected final ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField restrictedSegment;

    public ShieldInformationBarrierSegmentRestrictionMiniBuilder(ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField shieldInformationBarrierSegment, ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField restrictedSegment) {
      super();
      this.shieldInformationBarrierSegment = shieldInformationBarrierSegment;
      this.restrictedSegment = restrictedSegment;
    }
    ...
    @Override
    public ShieldInformationBarrierSegmentRestrictionMiniBuilder type(ShieldInformationBarrierSegmentRestrictionBaseTypeField type) {
