...
public class SkillCardsMetadata {
  ...
  public int hashCode() {
    return Objects.hash(
      canEdit, id, parent, scope, template, type, typeVersion, version, cards
    );
  }

  @Override
  public String toString() {
    return "SkillCardsMetadata{" + "canEdit='" + canEdit + '\'' + ", " + "id='" + id + '\'' + ", " + "parent='" + parent + '\'' + ", " + "scope='" + scope + '\'' + ", " + "template='" + template + '\'' + ", " + "type='" + type + '\'' + ", " + "typeVersion='" + typeVersion + '\'' + ", " + "version='" + version + '\'' + ", " + "cards='" + cards + '\'' + "}";
  }
  ...
  public static class SkillCardsMetadataBuilder {
    ...
    public SkillCardsMetadataBuilder cards(List<KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard> cards) {
      this.cards = cards;
      return this;
    }
