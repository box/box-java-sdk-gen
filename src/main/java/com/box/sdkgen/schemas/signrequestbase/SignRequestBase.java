...
public class SignRequestBase {
  ...
  public static class SignRequestBaseBuilder {
    ...
    public SignRequestBaseBuilder isPhoneVerificationRequiredToView(Boolean isPhoneVerificationRequiredToView) {
