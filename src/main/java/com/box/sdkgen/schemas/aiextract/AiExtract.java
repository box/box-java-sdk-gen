...
public class AiExtract {
  ...
  public AiExtract(@JsonProperty("prompt") String prompt, @JsonProperty("items") List<AiItemBase> items) {
    this.prompt = prompt;
    this.items = items;
  }
  ...
  public int hashCode() {
    return Objects.hash(
      prompt, items, aiAgent
    );
  }

  @Override
  public String toString() {
    return "AiExtract{" + "prompt='" + prompt + '\'' + ", " + "items='" + items + '\'' + ", " + "aiAgent='" + aiAgent + '\'' + "}";
  }
