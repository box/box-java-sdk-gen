...
public class Collaboration {
  ...
  public Collaboration(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<CollaborationTypeField>(CollaborationTypeField.COLLABORATION.getValue(), CollaborationTypeField.COLLABORATION);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, item, appItem, accessibleBy, inviteEmail, role, expiresAt, isAccessOnly, status, acknowledgedAt, createdBy, createdAt, modifiedAt, acceptanceRequirementsStatus
    );
  }

  @Override
  public String toString() {
    return "Collaboration{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "item='" + item + '\'' + ", " + "appItem='" + appItem + '\'' + ", " + "accessibleBy='" + accessibleBy + '\'' + ", " + "inviteEmail='" + inviteEmail + '\'' + ", " + "role='" + role + '\'' + ", " + "expiresAt='" + expiresAt + '\'' + ", " + "isAccessOnly='" + isAccessOnly + '\'' + ", " + "status='" + status + '\'' + ", " + "acknowledgedAt='" + acknowledgedAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "acceptanceRequirementsStatus='" + acceptanceRequirementsStatus + '\'' + "}";
  }
  ...
  public static class CollaborationBuilder {
    ...
    public CollaborationBuilder acceptanceRequirementsStatus(CollaborationAcceptanceRequirementsStatusField acceptanceRequirementsStatus) {
