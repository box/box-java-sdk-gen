...
public class Webhook extends WebhookMini {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, target, createdBy, createdAt, address, triggers
    );
  }

  @Override
  public String toString() {
    return "Webhook{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "target='" + target + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "address='" + address + '\'' + ", " + "triggers='" + triggers + '\'' + "}";
  }
