...
public enum WebhookTriggersField {
  ...
  public static class WebhookTriggersFieldDeserializer extends JsonDeserializer<EnumWrapper<WebhookTriggersField>> {
    ...
    @Override
    public EnumWrapper<WebhookTriggersField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(WebhookTriggersField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<WebhookTriggersField>(value, v)).orElse(new EnumWrapper<WebhookTriggersField>(value));
    }

  }

  public static class WebhookTriggersFieldSerializer extends JsonSerializer<EnumWrapper<WebhookTriggersField>> {
    ...
    @Override
    public void serialize(EnumWrapper<WebhookTriggersField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
