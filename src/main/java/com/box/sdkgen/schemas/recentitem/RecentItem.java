...
public class RecentItem {
  ...
  public int hashCode() {
    return Objects.hash(
      type, item, interactionType, interactedAt, interactionSharedLink
    );
  }

  @Override
  public String toString() {
    return "RecentItem{" + "type='" + type + '\'' + ", " + "item='" + item + '\'' + ", " + "interactionType='" + interactionType + '\'' + ", " + "interactedAt='" + interactedAt + '\'' + ", " + "interactionSharedLink='" + interactionSharedLink + '\'' + "}";
  }
  ...
  public static class RecentItemBuilder {
    ...
    public RecentItemBuilder interactionType(RecentItemInteractionTypeField interactionType) {
      this.interactionType = new EnumWrapper<RecentItemInteractionTypeField>(interactionType.getValue(), interactionType);
      return this;
    }
