...
public class WebLinkBase {
  ...
  public WebLinkBase(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<WebLinkBaseTypeField>(WebLinkBaseTypeField.WEB_LINK.getValue(), WebLinkBaseTypeField.WEB_LINK);
  }
  ...
  public String toString() {
    return "WebLinkBase{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "etag='" + etag + '\'' + "}";
  }
