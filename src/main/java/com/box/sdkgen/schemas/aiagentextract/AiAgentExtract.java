...
public class AiAgentExtract {
  ...
  public AiAgentExtract() {
    this.type = new EnumWrapper<AiAgentExtractTypeField>(AiAgentExtractTypeField.AI_AGENT_EXTRACT.getValue(), AiAgentExtractTypeField.AI_AGENT_EXTRACT);
  }
  ...
  public String toString() {
    return "AiAgentExtract{" + "type='" + type + '\'' + ", " + "longText='" + longText + '\'' + ", " + "basicText='" + basicText + '\'' + "}";
  }
