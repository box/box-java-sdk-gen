...
@JsonDeserialize(
    using =
        AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi
            .AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAiDeserializer.class)
@JsonSerialize(using = OneOfTwo.OneOfTwoSerializer.class)
public class AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi
    extends OneOfTwo<AiLlmEndpointParamsGoogle, AiLlmEndpointParamsOpenAi> {
  ...
  static class AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAiDeserializer
      extends JsonDeserializer<AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi> {
    ...
    @Override
    public AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi deserialize(
      ...
      if (!(discriminant0 == null)) {
        switch (discriminant0.asText()) {
          case "google_params":
            return new AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi(
      ...
      throw new JsonMappingException(
          jp, "Unable to deserialize AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi");
    }
  }
}
