...
public class EventSource {
  ...
  public EventSource(@JsonProperty("item_type") EnumWrapper<EventSourceItemTypeField> itemType, @JsonProperty("item_id") String itemId, @JsonProperty("item_name") String itemName) {
  ...
  public int hashCode() {
    return Objects.hash(
      itemType, itemId, itemName, classification, parent, ownedBy
    );
  }

  @Override
  public String toString() {
    return "EventSource{" + "itemType='" + itemType + '\'' + ", " + "itemId='" + itemId + '\'' + ", " + "itemName='" + itemName + '\'' + ", " + "classification='" + classification + '\'' + ", " + "parent='" + parent + '\'' + ", " + "ownedBy='" + ownedBy + '\'' + "}";
  }
