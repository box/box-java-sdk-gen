...
public class MetadataFull extends Metadata {
  ...
  public String toString() {
    return "MetadataFull{" + "parent='" + parent + '\'' + ", " + "template='" + template + '\'' + ", " + "scope='" + scope + '\'' + ", " + "version='" + version + '\'' + ", " + "canEdit='" + canEdit + '\'' + ", " + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "typeVersion='" + typeVersion + '\'' + ", " + "extraData='" + extraData + '\'' + "}";
  }
