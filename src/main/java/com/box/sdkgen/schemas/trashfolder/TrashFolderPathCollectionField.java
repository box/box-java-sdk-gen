...
public class TrashFolderPathCollectionField {
  ...
  public TrashFolderPathCollectionField(@JsonProperty("total_count") long totalCount, @JsonProperty("entries") List<TrashFolderPathCollectionEntriesField> entries) {
  ...
  public String toString() {
    return "TrashFolderPathCollectionField{" + "totalCount='" + totalCount + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
