...
public class FolderLock {
  ...
  public int hashCode() {
    return Objects.hash(
      folder, id, type, createdBy, createdAt, lockedOperations, lockType
    );
  }

  @Override
  public String toString() {
    return "FolderLock{" + "folder='" + folder + '\'' + ", " + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "lockedOperations='" + lockedOperations + '\'' + ", " + "lockType='" + lockType + '\'' + "}";
  }
