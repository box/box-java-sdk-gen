...
public class AppItemEventSource {
  ...
  public AppItemEventSource(@JsonProperty("id") String id, @JsonProperty("app_item_type") String appItemType) {
    this.id = id;
    this.appItemType = appItemType;
    this.type = new EnumWrapper<AppItemEventSourceTypeField>(AppItemEventSourceTypeField.APP_ITEM.getValue(), AppItemEventSourceTypeField.APP_ITEM);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, appItemType, user, group
    );
  }

  @Override
  public String toString() {
    return "AppItemEventSource{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "appItemType='" + appItemType + '\'' + ", " + "user='" + user + '\'' + ", " + "group='" + group + '\'' + "}";
  }
