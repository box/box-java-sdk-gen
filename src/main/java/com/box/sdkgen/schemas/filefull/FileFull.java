...
public class FileFull extends File {
  ...
  public static class FileFullBuilder extends FileBuilder {
    ...
    public FileFullBuilder allowedInviteeRoles(List<FileFullAllowedInviteeRolesField> allowedInviteeRoles) {
    ...
    public FileFullBuilder sharedLinkPermissionOptions(List<FileFullSharedLinkPermissionOptionsField> sharedLinkPermissionOptions) {
