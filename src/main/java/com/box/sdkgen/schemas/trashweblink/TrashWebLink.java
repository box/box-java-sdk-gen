...
public class TrashWebLink {
  ...
  public static class TrashWebLinkBuilder {
    ...
    public TrashWebLinkBuilder itemStatus(TrashWebLinkItemStatusField itemStatus) {
      this.itemStatus = new EnumWrapper<TrashWebLinkItemStatusField>(itemStatus.getValue(), itemStatus);
      return this;
    }
