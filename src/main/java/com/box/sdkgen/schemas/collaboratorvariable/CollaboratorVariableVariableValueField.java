...
public class CollaboratorVariableVariableValueField {
  ...
  public CollaboratorVariableVariableValueField(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<CollaboratorVariableVariableValueTypeField>(CollaboratorVariableVariableValueTypeField.USER.getValue(), CollaboratorVariableVariableValueTypeField.USER);
  }

  protected CollaboratorVariableVariableValueField(CollaboratorVariableVariableValueFieldBuilder builder) {
  ...
  public String toString() {
    return "CollaboratorVariableVariableValueField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
  ...
  public static class CollaboratorVariableVariableValueFieldBuilder {
    ...
    public CollaboratorVariableVariableValueFieldBuilder type(CollaboratorVariableVariableValueTypeField type) {
      this.type = new EnumWrapper<CollaboratorVariableVariableValueTypeField>(type.getValue(), type);
      return this;
    }
