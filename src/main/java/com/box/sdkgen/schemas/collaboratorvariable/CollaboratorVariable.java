...
public class CollaboratorVariable {
  ...
  public CollaboratorVariable(@JsonProperty("variable_value") List<CollaboratorVariableVariableValueField> variableValue) {
    this.variableValue = variableValue;
    this.type = new EnumWrapper<CollaboratorVariableTypeField>(CollaboratorVariableTypeField.VARIABLE.getValue(), CollaboratorVariableTypeField.VARIABLE);
    this.variableType = new EnumWrapper<CollaboratorVariableVariableTypeField>(CollaboratorVariableVariableTypeField.USER_LIST.getValue(), CollaboratorVariableVariableTypeField.USER_LIST);
  }
  ...
  public String toString() {
    return "CollaboratorVariable{" + "type='" + type + '\'' + ", " + "variableType='" + variableType + '\'' + ", " + "variableValue='" + variableValue + '\'' + "}";
  }
  ...
  public static class CollaboratorVariableBuilder {
    ...
    public CollaboratorVariableBuilder variableType(CollaboratorVariableVariableTypeField variableType) {
      this.variableType = new EnumWrapper<CollaboratorVariableVariableTypeField>(variableType.getValue(), variableType);
      return this;
    }
