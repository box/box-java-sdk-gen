...
@JsonDeserialize(using = FileFullOrFolderFullOrWebLink.FileFullOrFolderFullOrWebLinkDeserializer.class)
...
public class FileFullOrFolderFullOrWebLink extends OneOfThree<FileFull, FolderFull, WebLink> {
  ...
  static class FileFullOrFolderFullOrWebLinkDeserializer extends JsonDeserializer<FileFullOrFolderFullOrWebLink> {
    ...
    @Override
    public FileFullOrFolderFullOrWebLink deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
      ...
      if(!(discriminant0 == null)){
        switch (discriminant0.asText()) {
          ...
          case "folder":
            return new FileFullOrFolderFullOrWebLink(JsonManager.deserialize(node, FolderFull.class));
          case "web_link":
