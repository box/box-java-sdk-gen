...
public class AiAgentLongTextTool extends AiAgentBasicTextTool {
  ...
  public String toString() {
    return "AiAgentLongTextTool{" + "model='" + model + '\'' + ", " + "numTokensForCompletion='" + numTokensForCompletion + '\'' + ", " + "llmEndpointParams='" + llmEndpointParams + '\'' + ", " + "systemMessage='" + systemMessage + '\'' + ", " + "promptTemplate='" + promptTemplate + '\'' + ", " + "embeddings='" + embeddings + '\'' + "}";
  }
  ...
  public static class AiAgentLongTextToolBuilder extends AiAgentBasicTextToolBuilder {
    ...
    @Override
    public AiAgentLongTextToolBuilder llmEndpointParams(AiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi llmEndpointParams) {
