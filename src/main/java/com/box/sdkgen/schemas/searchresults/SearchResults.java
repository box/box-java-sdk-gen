...
public class SearchResults {
  ...
  public SearchResults() {
    this.type = new EnumWrapper<SearchResultsTypeField>(SearchResultsTypeField.SEARCH_RESULTS_ITEMS.getValue(), SearchResultsTypeField.SEARCH_RESULTS_ITEMS);
  }
  ...
  public String toString() {
    return "SearchResults{" + "totalCount='" + totalCount + '\'' + ", " + "limit='" + limit + '\'' + ", " + "offset='" + offset + '\'' + ", " + "type='" + type + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
