...
public class Invite {
  ...
  public Invite(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<InviteTypeField>(InviteTypeField.INVITE.getValue(), InviteTypeField.INVITE);
  }
  ...
  public String toString() {
    return "Invite{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "invitedTo='" + invitedTo + '\'' + ", " + "actionableBy='" + actionableBy + '\'' + ", " + "invitedBy='" + invitedBy + '\'' + ", " + "status='" + status + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + "}";
  }
