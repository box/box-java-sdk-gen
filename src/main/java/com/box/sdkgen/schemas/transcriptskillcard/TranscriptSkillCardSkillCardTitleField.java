...
public class TranscriptSkillCardSkillCardTitleField {
  ...
  protected TranscriptSkillCardSkillCardTitleField(TranscriptSkillCardSkillCardTitleFieldBuilder builder) {
  ...
  public String toString() {
    return "TranscriptSkillCardSkillCardTitleField{" + "code='" + code + '\'' + ", " + "message='" + message + '\'' + "}";
  }
