...
public class CollaborationAllowlistEntry {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, domain, direction, enterprise, createdAt
    );
  }

  @Override
  public String toString() {
    return "CollaborationAllowlistEntry{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "domain='" + domain + '\'' + ", " + "direction='" + direction + '\'' + ", " + "enterprise='" + enterprise + '\'' + ", " + "createdAt='" + createdAt + '\'' + "}";
  }
  ...
  public static class CollaborationAllowlistEntryBuilder {
    ...
    public CollaborationAllowlistEntryBuilder direction(CollaborationAllowlistEntryDirectionField direction) {
      this.direction = new EnumWrapper<CollaborationAllowlistEntryDirectionField>(direction.getValue(), direction);
      return this;
    }

    public CollaborationAllowlistEntryBuilder enterprise(CollaborationAllowlistEntryEnterpriseField enterprise) {
