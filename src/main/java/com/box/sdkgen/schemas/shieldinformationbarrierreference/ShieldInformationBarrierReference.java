...
public class ShieldInformationBarrierReference {
  ...
  public String toString() {
    return "ShieldInformationBarrierReference{" + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierReferenceBuilder {
    ...
    public ShieldInformationBarrierReferenceBuilder shieldInformationBarrier(ShieldInformationBarrierBase shieldInformationBarrier) {
