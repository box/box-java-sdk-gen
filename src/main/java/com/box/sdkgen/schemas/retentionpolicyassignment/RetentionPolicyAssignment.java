...
public class RetentionPolicyAssignment {
  ...
  public RetentionPolicyAssignment(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<RetentionPolicyAssignmentTypeField>(RetentionPolicyAssignmentTypeField.RETENTION_POLICY_ASSIGNMENT.getValue(), RetentionPolicyAssignmentTypeField.RETENTION_POLICY_ASSIGNMENT);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, retentionPolicy, assignedTo, filterFields, assignedBy, assignedAt, startDateField
    );
  }

  @Override
  public String toString() {
    return "RetentionPolicyAssignment{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "retentionPolicy='" + retentionPolicy + '\'' + ", " + "assignedTo='" + assignedTo + '\'' + ", " + "filterFields='" + filterFields + '\'' + ", " + "assignedBy='" + assignedBy + '\'' + ", " + "assignedAt='" + assignedAt + '\'' + ", " + "startDateField='" + startDateField + '\'' + "}";
  }
  ...
  public static class RetentionPolicyAssignmentBuilder {
    ...
    public RetentionPolicyAssignmentBuilder type(RetentionPolicyAssignmentTypeField type) {
      this.type = new EnumWrapper<RetentionPolicyAssignmentTypeField>(type.getValue(), type);
      return this;
    }
    ...
    public RetentionPolicyAssignmentBuilder assignedTo(RetentionPolicyAssignmentAssignedToField assignedTo) {
      this.assignedTo = assignedTo;
      return this;
    }

    public RetentionPolicyAssignmentBuilder filterFields(List<RetentionPolicyAssignmentFilterFieldsField> filterFields) {
