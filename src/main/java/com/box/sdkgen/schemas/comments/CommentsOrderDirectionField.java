...
public enum CommentsOrderDirectionField {
  ...
  public static class CommentsOrderDirectionFieldDeserializer extends JsonDeserializer<EnumWrapper<CommentsOrderDirectionField>> {
    ...
    @Override
    public EnumWrapper<CommentsOrderDirectionField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(CommentsOrderDirectionField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<CommentsOrderDirectionField>(value, v)).orElse(new EnumWrapper<CommentsOrderDirectionField>(value));
    }
  ...
  public static class CommentsOrderDirectionFieldSerializer extends JsonSerializer<EnumWrapper<CommentsOrderDirectionField>> {
    ...
    @Override
    public void serialize(EnumWrapper<CommentsOrderDirectionField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
