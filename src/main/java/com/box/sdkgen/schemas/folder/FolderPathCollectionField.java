...
public class FolderPathCollectionField {
  ...
  public FolderPathCollectionField(@JsonProperty("total_count") long totalCount, @JsonProperty("entries") List<FolderMini> entries) {
  ...
  public boolean equals(Object o) {
    ...
    FolderPathCollectionField casted = (FolderPathCollectionField) o;
  ...
  public String toString() {
    return "FolderPathCollectionField{" + "totalCount='" + totalCount + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
