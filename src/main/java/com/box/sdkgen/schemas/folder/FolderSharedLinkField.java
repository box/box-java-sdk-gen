...
public class FolderSharedLinkField {
  ...
  public FolderSharedLinkField(@JsonProperty("url") String url, @JsonProperty("effective_access") EnumWrapper<FolderSharedLinkEffectiveAccessField> effectiveAccess, @JsonProperty("effective_permission") EnumWrapper<FolderSharedLinkEffectivePermissionField> effectivePermission, @JsonProperty("is_password_enabled") boolean isPasswordEnabled, @JsonProperty("download_count") long downloadCount, @JsonProperty("preview_count") long previewCount) {
    this.url = url;
  ...
  public FolderSharedLinkField(String url, FolderSharedLinkEffectiveAccessField effectiveAccess, FolderSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
    this.url = url;
    this.effectiveAccess = new EnumWrapper<FolderSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
    this.effectivePermission = new EnumWrapper<FolderSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
    this.isPasswordEnabled = isPasswordEnabled;
    this.downloadCount = downloadCount;
    this.previewCount = previewCount;
  }
  ...
  public String toString() {
    return "FolderSharedLinkField{" + "url='" + url + '\'' + ", " + "downloadUrl='" + downloadUrl + '\'' + ", " + "vanityUrl='" + vanityUrl + '\'' + ", " + "vanityName='" + vanityName + '\'' + ", " + "access='" + access + '\'' + ", " + "effectiveAccess='" + effectiveAccess + '\'' + ", " + "effectivePermission='" + effectivePermission + '\'' + ", " + "unsharedAt='" + unsharedAt + '\'' + ", " + "isPasswordEnabled='" + isPasswordEnabled + '\'' + ", " + "permissions='" + permissions + '\'' + ", " + "downloadCount='" + downloadCount + '\'' + ", " + "previewCount='" + previewCount + '\'' + "}";
  }
  ...
  public static class FolderSharedLinkFieldBuilder {
    ...
    public FolderSharedLinkFieldBuilder(String url, FolderSharedLinkEffectiveAccessField effectiveAccess, FolderSharedLinkEffectivePermissionField effectivePermission, boolean isPasswordEnabled, long downloadCount, long previewCount) {
      this.url = url;
      this.effectiveAccess = new EnumWrapper<FolderSharedLinkEffectiveAccessField>(effectiveAccess.getValue(), effectiveAccess);
      this.effectivePermission = new EnumWrapper<FolderSharedLinkEffectivePermissionField>(effectivePermission.getValue(), effectivePermission);
      this.isPasswordEnabled = isPasswordEnabled;
