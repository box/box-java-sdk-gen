...
public class Task {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, item, dueAt, action, message, taskAssignmentCollection, isCompleted, createdBy, createdAt, completionRule
    );
  }

  @Override
  public String toString() {
    return "Task{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "item='" + item + '\'' + ", " + "dueAt='" + dueAt + '\'' + ", " + "action='" + action + '\'' + ", " + "message='" + message + '\'' + ", " + "taskAssignmentCollection='" + taskAssignmentCollection + '\'' + ", " + "isCompleted='" + isCompleted + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "completionRule='" + completionRule + '\'' + "}";
  }
  ...
  public static class TaskBuilder {
    ...
    public TaskBuilder completionRule(TaskCompletionRuleField completionRule) {
      this.completionRule = new EnumWrapper<TaskCompletionRuleField>(completionRule.getValue(), completionRule);
      return this;
    }
