...
public class GroupMembership {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, user, group, role, createdAt, modifiedAt
    );
  }

  @Override
  public String toString() {
    return "GroupMembership{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "user='" + user + '\'' + ", " + "group='" + group + '\'' + ", " + "role='" + role + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + "}";
  }
