...
public class SearchResultWithSharedLink {
  ...
  public int hashCode() {
    return Objects.hash(
      accessibleViaSharedLink, item, type
    );
  }

  @Override
  public String toString() {
    return "SearchResultWithSharedLink{" + "accessibleViaSharedLink='" + accessibleViaSharedLink + '\'' + ", " + "item='" + item + '\'' + ", " + "type='" + type + '\'' + "}";
  }
  ...
  public static class SearchResultWithSharedLinkBuilder {
    ...
    public SearchResultWithSharedLinkBuilder accessibleViaSharedLink(String accessibleViaSharedLink) {
