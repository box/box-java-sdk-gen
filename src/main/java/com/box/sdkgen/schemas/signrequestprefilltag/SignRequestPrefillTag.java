...
public class SignRequestPrefillTag {
  ...
  public int hashCode() {
    return Objects.hash(
      documentTagId, textValue, checkboxValue, dateValue
    );
  }

  @Override
  public String toString() {
    return "SignRequestPrefillTag{" + "documentTagId='" + documentTagId + '\'' + ", " + "textValue='" + textValue + '\'' + ", " + "checkboxValue='" + checkboxValue + '\'' + ", " + "dateValue='" + dateValue + '\'' + "}";
  }
