...
public class MetadataTemplate {
  ...
  public MetadataTemplate(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<MetadataTemplateTypeField>(MetadataTemplateTypeField.METADATA_TEMPLATE.getValue(), MetadataTemplateTypeField.METADATA_TEMPLATE);
  }
  ...
  public String toString() {
    return "MetadataTemplate{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "scope='" + scope + '\'' + ", " + "templateKey='" + templateKey + '\'' + ", " + "displayName='" + displayName + '\'' + ", " + "hidden='" + hidden + '\'' + ", " + "fields='" + fields + '\'' + ", " + "copyInstanceOnItemCopy='" + copyInstanceOnItemCopy + '\'' + "}";
  }
