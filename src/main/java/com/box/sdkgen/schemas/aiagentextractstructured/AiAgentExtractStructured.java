...
public class AiAgentExtractStructured {
  ...
  public AiAgentExtractStructured() {
    this.type = new EnumWrapper<AiAgentExtractStructuredTypeField>(AiAgentExtractStructuredTypeField.AI_AGENT_EXTRACT_STRUCTURED.getValue(), AiAgentExtractStructuredTypeField.AI_AGENT_EXTRACT_STRUCTURED);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      type, longText, basicText
    );
  }

  @Override
  public String toString() {
    return "AiAgentExtractStructured{" + "type='" + type + '\'' + ", " + "longText='" + longText + '\'' + ", " + "basicText='" + basicText + '\'' + "}";
  }
