...
public class ShieldInformationBarrierReports {
  ...
  public String toString() {
    return "ShieldInformationBarrierReports{" + "limit='" + limit + '\'' + ", " + "nextMarker='" + nextMarker + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierReportsBuilder {
    ...
    public ShieldInformationBarrierReportsBuilder entries(List<ShieldInformationBarrierReport> entries) {
