...
public class ShieldInformationBarrierSegments {
  ...
  public String toString() {
    return "ShieldInformationBarrierSegments{" + "limit='" + limit + '\'' + ", " + "nextMarker='" + nextMarker + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierSegmentsBuilder {
    ...
    public ShieldInformationBarrierSegmentsBuilder entries(List<ShieldInformationBarrierSegment> entries) {
