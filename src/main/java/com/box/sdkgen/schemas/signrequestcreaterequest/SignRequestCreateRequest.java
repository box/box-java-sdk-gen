...
public class SignRequestCreateRequest extends SignRequestBase {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(isDocumentPreparationNeeded, casted.isDocumentPreparationNeeded) &&
      ...
      Objects.equals(isPhoneVerificationRequiredToView, casted.isPhoneVerificationRequiredToView) &&
  ...
  public int hashCode() {
    return Objects.hash(
      isDocumentPreparationNeeded, redirectUrl, declinedRedirectUrl, areTextSignaturesEnabled, emailSubject, emailMessage, areRemindersEnabled, name, prefillTags, daysValid, externalId, isPhoneVerificationRequiredToView, templateId, externalSystemName, sourceFiles, signatureColor, signers, parentFolder
    );
  }

  @Override
  public String toString() {
    return "SignRequestCreateRequest{" + "isDocumentPreparationNeeded='" + isDocumentPreparationNeeded + '\'' + ", " + "redirectUrl='" + redirectUrl + '\'' + ", " + "declinedRedirectUrl='" + declinedRedirectUrl + '\'' + ", " + "areTextSignaturesEnabled='" + areTextSignaturesEnabled + '\'' + ", " + "emailSubject='" + emailSubject + '\'' + ", " + "emailMessage='" + emailMessage + '\'' + ", " + "areRemindersEnabled='" + areRemindersEnabled + '\'' + ", " + "name='" + name + '\'' + ", " + "prefillTags='" + prefillTags + '\'' + ", " + "daysValid='" + daysValid + '\'' + ", " + "externalId='" + externalId + '\'' + ", " + "isPhoneVerificationRequiredToView='" + isPhoneVerificationRequiredToView + '\'' + ", " + "templateId='" + templateId + '\'' + ", " + "externalSystemName='" + externalSystemName + '\'' + ", " + "sourceFiles='" + sourceFiles + '\'' + ", " + "signatureColor='" + signatureColor + '\'' + ", " + "signers='" + signers + '\'' + ", " + "parentFolder='" + parentFolder + '\'' + "}";
  }
  ...
  public static class SignRequestCreateRequestBuilder extends SignRequestBaseBuilder {
    ...
    public SignRequestCreateRequestBuilder signatureColor(SignRequestCreateRequestSignatureColorField signatureColor) {
      this.signatureColor = new EnumWrapper<SignRequestCreateRequestSignatureColorField>(signatureColor.getValue(), signatureColor);
      return this;
    }
    ...
    @Override
    public SignRequestCreateRequestBuilder isDocumentPreparationNeeded(Boolean isDocumentPreparationNeeded) {
    ...
    @Override
    public SignRequestCreateRequestBuilder areTextSignaturesEnabled(Boolean areTextSignaturesEnabled) {
    ...
    @Override
    public SignRequestCreateRequestBuilder isPhoneVerificationRequiredToView(Boolean isPhoneVerificationRequiredToView) {
