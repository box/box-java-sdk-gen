...
public class ShieldInformationBarrierSegmentRestriction extends ShieldInformationBarrierSegmentRestrictionMini {
  ...
  public ShieldInformationBarrierSegmentRestriction(@JsonProperty("shield_information_barrier_segment") ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField shieldInformationBarrierSegment, @JsonProperty("restricted_segment") ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField restrictedSegment) {
    super(shieldInformationBarrierSegment, restrictedSegment);
  }

  protected ShieldInformationBarrierSegmentRestriction(ShieldInformationBarrierSegmentRestrictionBuilder builder) {
    super(builder);
  ...
  public boolean equals(Object o) {
    ...
    ShieldInformationBarrierSegmentRestriction casted = (ShieldInformationBarrierSegmentRestriction) o;
  ...
  public int hashCode() {
    return Objects.hash(
      type, id, shieldInformationBarrierSegment, restrictedSegment, shieldInformationBarrier, createdAt, createdBy, updatedAt, updatedBy
    );
  }

  @Override
  public String toString() {
    return "ShieldInformationBarrierSegmentRestriction{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + ", " + "shieldInformationBarrierSegment='" + shieldInformationBarrierSegment + '\'' + ", " + "restrictedSegment='" + restrictedSegment + '\'' + ", " + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + ", " + "updatedBy='" + updatedBy + '\'' + "}";
  }

  public static class ShieldInformationBarrierSegmentRestrictionBuilder extends ShieldInformationBarrierSegmentRestrictionMiniBuilder {
    ...
    public ShieldInformationBarrierSegmentRestrictionBuilder(ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField shieldInformationBarrierSegment, ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField restrictedSegment) {
      super(shieldInformationBarrierSegment, restrictedSegment);
    }

    public ShieldInformationBarrierSegmentRestrictionBuilder shieldInformationBarrier(ShieldInformationBarrierBase shieldInformationBarrier) {
    ...
    @Override
    public ShieldInformationBarrierSegmentRestrictionBuilder type(ShieldInformationBarrierSegmentRestrictionBaseTypeField type) {
