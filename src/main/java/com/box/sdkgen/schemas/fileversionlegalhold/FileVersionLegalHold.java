...
public class FileVersionLegalHold {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, fileVersion, file, legalHoldPolicyAssignments, deletedAt
    );
  }

  @Override
  public String toString() {
    return "FileVersionLegalHold{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "fileVersion='" + fileVersion + '\'' + ", " + "file='" + file + '\'' + ", " + "legalHoldPolicyAssignments='" + legalHoldPolicyAssignments + '\'' + ", " + "deletedAt='" + deletedAt + '\'' + "}";
  }
  ...
  public static class FileVersionLegalHoldBuilder {
    ...
    public FileVersionLegalHoldBuilder legalHoldPolicyAssignments(List<LegalHoldPolicyAssignment> legalHoldPolicyAssignments) {
