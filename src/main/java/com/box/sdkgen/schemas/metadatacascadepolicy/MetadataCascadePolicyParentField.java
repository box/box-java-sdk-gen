...
public class MetadataCascadePolicyParentField {
  ...
  @JsonDeserialize(using = MetadataCascadePolicyParentTypeField.MetadataCascadePolicyParentTypeFieldDeserializer.class)
  @JsonSerialize(using = MetadataCascadePolicyParentTypeField.MetadataCascadePolicyParentTypeFieldSerializer.class)
  ...
  public String toString() {
    return "MetadataCascadePolicyParentField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
