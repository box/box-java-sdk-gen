...
public class IntegrationMappingSlackCreateRequest {
  ...
  public IntegrationMappingSlackCreateRequest(@JsonProperty("partner_item") IntegrationMappingPartnerItemSlack partnerItem, @JsonProperty("box_item") IntegrationMappingBoxItemSlack boxItem) {
    this.partnerItem = partnerItem;
    this.boxItem = boxItem;
  }

  protected IntegrationMappingSlackCreateRequest(IntegrationMappingSlackCreateRequestBuilder builder) {
  ...
  public int hashCode() {
    return Objects.hash(
      partnerItem, boxItem, options
    );
  }

  @Override
  public String toString() {
    return "IntegrationMappingSlackCreateRequest{" + "partnerItem='" + partnerItem + '\'' + ", " + "boxItem='" + boxItem + '\'' + ", " + "options='" + options + '\'' + "}";
  }
  ...
  public static class IntegrationMappingSlackCreateRequestBuilder {
    ...
    public IntegrationMappingSlackCreateRequestBuilder(IntegrationMappingPartnerItemSlack partnerItem, IntegrationMappingBoxItemSlack boxItem) {
      this.partnerItem = partnerItem;
      this.boxItem = boxItem;
    }

    public IntegrationMappingSlackCreateRequestBuilder options(IntegrationMappingSlackOptions options) {
