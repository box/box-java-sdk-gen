...
public class FileRequest {
  ...
  public FileRequest(@JsonProperty("id") String id, @JsonProperty("folder") FolderMini folder, @JsonProperty("created_at") String createdAt, @JsonProperty("updated_at") String updatedAt) {
    this.id = id;
    this.folder = folder;
    this.createdAt = createdAt;
    this.updatedAt = updatedAt;
    this.type = new EnumWrapper<FileRequestTypeField>(FileRequestTypeField.FILE_REQUEST.getValue(), FileRequestTypeField.FILE_REQUEST);
  }
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, title, description, status, isEmailRequired, isDescriptionRequired, expiresAt, folder, url, etag, createdBy, createdAt, updatedBy, updatedAt
    );
  }

  @Override
  public String toString() {
    return "FileRequest{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "title='" + title + '\'' + ", " + "description='" + description + '\'' + ", " + "status='" + status + '\'' + ", " + "isEmailRequired='" + isEmailRequired + '\'' + ", " + "isDescriptionRequired='" + isDescriptionRequired + '\'' + ", " + "expiresAt='" + expiresAt + '\'' + ", " + "folder='" + folder + '\'' + ", " + "url='" + url + '\'' + ", " + "etag='" + etag + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "updatedBy='" + updatedBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + "}";
  }
