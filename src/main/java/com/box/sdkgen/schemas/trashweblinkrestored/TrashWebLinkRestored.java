...
public class TrashWebLinkRestored {
  ...
  @JsonDeserialize(using = TrashWebLinkRestoredTypeField.TrashWebLinkRestoredTypeFieldDeserializer.class)
  @JsonSerialize(using = TrashWebLinkRestoredTypeField.TrashWebLinkRestoredTypeFieldSerializer.class)
  ...
  @JsonDeserialize(using = TrashWebLinkRestoredItemStatusField.TrashWebLinkRestoredItemStatusFieldDeserializer.class)
  @JsonSerialize(using = TrashWebLinkRestoredItemStatusField.TrashWebLinkRestoredItemStatusFieldSerializer.class)
  @JsonProperty("item_status")
  protected EnumWrapper<TrashWebLinkRestoredItemStatusField> itemStatus;

  public TrashWebLinkRestored(@JsonProperty("sequence_id") String sequenceId, @JsonProperty("path_collection") TrashWebLinkRestoredPathCollectionField pathCollection) {
  ...
  public static class TrashWebLinkRestoredBuilder {
    ...
    public TrashWebLinkRestoredBuilder(String sequenceId, TrashWebLinkRestoredPathCollectionField pathCollection) {
      this.sequenceId = sequenceId;
      this.pathCollection = pathCollection;
    }
    ...
    public TrashWebLinkRestoredBuilder itemStatus(TrashWebLinkRestoredItemStatusField itemStatus) {
      this.itemStatus = new EnumWrapper<TrashWebLinkRestoredItemStatusField>(itemStatus.getValue(), itemStatus);
      return this;
    }
