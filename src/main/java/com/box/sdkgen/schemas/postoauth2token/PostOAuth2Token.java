...
public class PostOAuth2Token {
  ...
  public PostOAuth2Token(@JsonProperty("grant_type") EnumWrapper<PostOAuth2TokenGrantTypeField> grantType) {
    this.grantType = grantType;
  }

  public PostOAuth2Token(PostOAuth2TokenGrantTypeField grantType) {
    this.grantType = new EnumWrapper<PostOAuth2TokenGrantTypeField>(grantType.getValue(), grantType);
  }
  ...
  public static class PostOAuth2TokenBuilder {
    ...
    public PostOAuth2TokenBuilder subjectTokenType(PostOAuth2TokenSubjectTokenTypeField subjectTokenType) {
      this.subjectTokenType = new EnumWrapper<PostOAuth2TokenSubjectTokenTypeField>(subjectTokenType.getValue(), subjectTokenType);
      return this;
    }
    ...
    public PostOAuth2TokenBuilder actorTokenType(PostOAuth2TokenActorTokenTypeField actorTokenType) {
      this.actorTokenType = new EnumWrapper<PostOAuth2TokenActorTokenTypeField>(actorTokenType.getValue(), actorTokenType);
      return this;
    }
    ...
    public PostOAuth2TokenBuilder boxSubjectType(PostOAuth2TokenBoxSubjectTypeField boxSubjectType) {
      this.boxSubjectType = new EnumWrapper<PostOAuth2TokenBoxSubjectTypeField>(boxSubjectType.getValue(), boxSubjectType);
      return this;
    }
