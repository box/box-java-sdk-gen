...
public class AccessToken {
  ...
  public String toString() {
    return "AccessToken{" + "accessToken='" + accessToken + '\'' + ", " + "expiresIn='" + expiresIn + '\'' + ", " + "tokenType='" + tokenType + '\'' + ", " + "restrictedTo='" + restrictedTo + '\'' + ", " + "refreshToken='" + refreshToken + '\'' + ", " + "issuedTokenType='" + issuedTokenType + '\'' + "}";
  }
  ...
  public static class AccessTokenBuilder {
    ...
    public AccessTokenBuilder issuedTokenType(AccessTokenIssuedTokenTypeField issuedTokenType) {
      this.issuedTokenType = new EnumWrapper<AccessTokenIssuedTokenTypeField>(issuedTokenType.getValue(), issuedTokenType);
      return this;
    }
