...
public class CollaborationAllowlistExemptTarget {
  ...
  @JsonDeserialize(using = CollaborationAllowlistExemptTargetTypeField.CollaborationAllowlistExemptTargetTypeFieldDeserializer.class)
  @JsonSerialize(using = CollaborationAllowlistExemptTargetTypeField.CollaborationAllowlistExemptTargetTypeFieldSerializer.class)
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, enterprise, user, createdAt, modifiedAt
    );
  }

  @Override
  public String toString() {
    return "CollaborationAllowlistExemptTarget{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "enterprise='" + enterprise + '\'' + ", " + "user='" + user + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + "}";
  }
  ...
  public static class CollaborationAllowlistExemptTargetBuilder {
    ...
    public CollaborationAllowlistExemptTargetBuilder type(CollaborationAllowlistExemptTargetTypeField type) {
      this.type = new EnumWrapper<CollaborationAllowlistExemptTargetTypeField>(type.getValue(), type);
      return this;
    }

    public CollaborationAllowlistExemptTargetBuilder enterprise(CollaborationAllowlistExemptTargetEnterpriseField enterprise) {
