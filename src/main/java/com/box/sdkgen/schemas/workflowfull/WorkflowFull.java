...
public class WorkflowFull extends Workflow {
  ...
  public int hashCode() {
    return Objects.hash(
      id, type, name, description, isEnabled, flows, createdAt, modifiedAt, createdBy, modifiedBy
    );
  }

  @Override
  public String toString() {
    return "WorkflowFull{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "name='" + name + '\'' + ", " + "description='" + description + '\'' + ", " + "isEnabled='" + isEnabled + '\'' + ", " + "flows='" + flows + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "modifiedBy='" + modifiedBy + '\'' + "}";
  }
