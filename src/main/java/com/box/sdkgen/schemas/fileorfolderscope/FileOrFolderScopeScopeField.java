...
public enum FileOrFolderScopeScopeField {
  ...
  public static class FileOrFolderScopeScopeFieldDeserializer extends JsonDeserializer<EnumWrapper<FileOrFolderScopeScopeField>> {
    ...
    @Override
    public EnumWrapper<FileOrFolderScopeScopeField> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      String value = p.getValueAsString();
      return Arrays.stream(FileOrFolderScopeScopeField.values()).filter(v -> v.getValue().equalsIgnoreCase(value)).findFirst().map(v -> new EnumWrapper<FileOrFolderScopeScopeField>(value, v)).orElse(new EnumWrapper<FileOrFolderScopeScopeField>(value));
    }
  ...
  public static class FileOrFolderScopeScopeFieldSerializer extends JsonSerializer<EnumWrapper<FileOrFolderScopeScopeField>> {
    ...
    @Override
    public void serialize(EnumWrapper<FileOrFolderScopeScopeField> value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
