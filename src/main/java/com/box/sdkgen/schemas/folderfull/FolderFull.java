...
public class FolderFull extends Folder {
  ...
  public int hashCode() {
    return Objects.hash(
      id, etag, type, sequenceId, name, createdAt, modifiedAt, description, size, pathCollection, createdBy, modifiedBy, trashedAt, purgedAt, contentCreatedAt, contentModifiedAt, ownedBy, sharedLink, folderUploadEmail, parent, itemStatus, itemCollection, syncState, hasCollaborations, permissions, tags, canNonOwnersInvite, isExternallyOwned, metadata, isCollaborationRestrictedToEnterprise, allowedSharedLinkAccessLevels, allowedInviteeRoles, watermarkInfo, isAccessibleViaSharedLink, canNonOwnersViewCollaborators, classification, isAssociatedWithAppItem
    );
  }

  @Override
  public String toString() {
    return "FolderFull{" + "id='" + id + '\'' + ", " + "etag='" + etag + '\'' + ", " + "type='" + type + '\'' + ", " + "sequenceId='" + sequenceId + '\'' + ", " + "name='" + name + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "modifiedAt='" + modifiedAt + '\'' + ", " + "description='" + description + '\'' + ", " + "size='" + size + '\'' + ", " + "pathCollection='" + pathCollection + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "modifiedBy='" + modifiedBy + '\'' + ", " + "trashedAt='" + trashedAt + '\'' + ", " + "purgedAt='" + purgedAt + '\'' + ", " + "contentCreatedAt='" + contentCreatedAt + '\'' + ", " + "contentModifiedAt='" + contentModifiedAt + '\'' + ", " + "ownedBy='" + ownedBy + '\'' + ", " + "sharedLink='" + sharedLink + '\'' + ", " + "folderUploadEmail='" + folderUploadEmail + '\'' + ", " + "parent='" + parent + '\'' + ", " + "itemStatus='" + itemStatus + '\'' + ", " + "itemCollection='" + itemCollection + '\'' + ", " + "syncState='" + syncState + '\'' + ", " + "hasCollaborations='" + hasCollaborations + '\'' + ", " + "permissions='" + permissions + '\'' + ", " + "tags='" + tags + '\'' + ", " + "canNonOwnersInvite='" + canNonOwnersInvite + '\'' + ", " + "isExternallyOwned='" + isExternallyOwned + '\'' + ", " + "metadata='" + metadata + '\'' + ", " + "isCollaborationRestrictedToEnterprise='" + isCollaborationRestrictedToEnterprise + '\'' + ", " + "allowedSharedLinkAccessLevels='" + allowedSharedLinkAccessLevels + '\'' + ", " + "allowedInviteeRoles='" + allowedInviteeRoles + '\'' + ", " + "watermarkInfo='" + watermarkInfo + '\'' + ", " + "isAccessibleViaSharedLink='" + isAccessibleViaSharedLink + '\'' + ", " + "canNonOwnersViewCollaborators='" + canNonOwnersViewCollaborators + '\'' + ", " + "classification='" + classification + '\'' + ", " + "isAssociatedWithAppItem='" + isAssociatedWithAppItem + '\'' + "}";
  }
  ...
  public static class FolderFullBuilder extends FolderBuilder {
    ...
    public FolderFullBuilder isCollaborationRestrictedToEnterprise(Boolean isCollaborationRestrictedToEnterprise) {
      this.isCollaborationRestrictedToEnterprise = isCollaborationRestrictedToEnterprise;
      return this;
    }

    public FolderFullBuilder allowedSharedLinkAccessLevels(List<FolderFullAllowedSharedLinkAccessLevelsField> allowedSharedLinkAccessLevels) {
      this.allowedSharedLinkAccessLevels = allowedSharedLinkAccessLevels;
      return this;
    }

    public FolderFullBuilder allowedInviteeRoles(List<FolderFullAllowedInviteeRolesField> allowedInviteeRoles) {
