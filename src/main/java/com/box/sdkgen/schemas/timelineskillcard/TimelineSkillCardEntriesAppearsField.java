...
public class TimelineSkillCardEntriesAppearsField {
  ...
  protected TimelineSkillCardEntriesAppearsField(TimelineSkillCardEntriesAppearsFieldBuilder builder) {
  ...
  public String toString() {
    return "TimelineSkillCardEntriesAppearsField{" + "start='" + start + '\'' + ", " + "end='" + end + '\'' + "}";
  }
