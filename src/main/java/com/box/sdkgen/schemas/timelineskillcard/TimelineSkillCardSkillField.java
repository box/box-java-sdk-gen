...
public class TimelineSkillCardSkillField {
  ...
  public TimelineSkillCardSkillField(@JsonProperty("id") String id) {
    this.id = id;
    this.type = new EnumWrapper<TimelineSkillCardSkillTypeField>(TimelineSkillCardSkillTypeField.SERVICE.getValue(), TimelineSkillCardSkillTypeField.SERVICE);
  }
  ...
  public String toString() {
    return "TimelineSkillCardSkillField{" + "type='" + type + '\'' + ", " + "id='" + id + '\'' + "}";
  }
