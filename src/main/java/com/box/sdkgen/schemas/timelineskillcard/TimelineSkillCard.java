...
public class TimelineSkillCard {
  ...
  public TimelineSkillCard(@JsonProperty("skill") TimelineSkillCardSkillField skill, @JsonProperty("invocation") TimelineSkillCardInvocationField invocation, @JsonProperty("entries") List<TimelineSkillCardEntriesField> entries) {
    this.skill = skill;
    this.invocation = invocation;
    this.entries = entries;
    this.type = new EnumWrapper<TimelineSkillCardTypeField>(TimelineSkillCardTypeField.SKILL_CARD.getValue(), TimelineSkillCardTypeField.SKILL_CARD);
    this.skillCardType = new EnumWrapper<TimelineSkillCardSkillCardTypeField>(TimelineSkillCardSkillCardTypeField.TIMELINE.getValue(), TimelineSkillCardSkillCardTypeField.TIMELINE);
  }
  ...
  public String toString() {
    return "TimelineSkillCard{" + "createdAt='" + createdAt + '\'' + ", " + "type='" + type + '\'' + ", " + "skillCardType='" + skillCardType + '\'' + ", " + "skillCardTitle='" + skillCardTitle + '\'' + ", " + "skill='" + skill + '\'' + ", " + "invocation='" + invocation + '\'' + ", " + "duration='" + duration + '\'' + ", " + "entries='" + entries + '\'' + "}";
  }
  ...
  public static class TimelineSkillCardBuilder {
    ...
    public TimelineSkillCardBuilder(TimelineSkillCardSkillField skill, TimelineSkillCardInvocationField invocation, List<TimelineSkillCardEntriesField> entries) {
      this.skill = skill;
      this.invocation = invocation;
      this.entries = entries;
      this.type = new EnumWrapper<TimelineSkillCardTypeField>(TimelineSkillCardTypeField.SKILL_CARD.getValue(), TimelineSkillCardTypeField.SKILL_CARD);
    ...
    public TimelineSkillCardBuilder skillCardType(TimelineSkillCardSkillCardTypeField skillCardType) {
      this.skillCardType = new EnumWrapper<TimelineSkillCardSkillCardTypeField>(skillCardType.getValue(), skillCardType);
      return this;
    }

    public TimelineSkillCardBuilder skillCardTitle(TimelineSkillCardSkillCardTitleField skillCardTitle) {
