...
public class FileRequestCopyRequest extends FileRequestUpdateRequest {
  ...
  public String toString() {
    return "FileRequestCopyRequest{" + "title='" + title + '\'' + ", " + "description='" + description + '\'' + ", " + "status='" + status + '\'' + ", " + "isEmailRequired='" + isEmailRequired + '\'' + ", " + "isDescriptionRequired='" + isDescriptionRequired + '\'' + ", " + "expiresAt='" + expiresAt + '\'' + ", " + "folder='" + folder + '\'' + "}";
  }
