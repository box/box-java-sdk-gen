...
public class TrashFolderRestored {
  ...
  public static class TrashFolderRestoredBuilder {
    ...
    public TrashFolderRestoredBuilder pathCollection(TrashFolderRestoredPathCollectionField pathCollection) {
    ...
    public TrashFolderRestoredBuilder itemStatus(TrashFolderRestoredItemStatusField itemStatus) {
      this.itemStatus = new EnumWrapper<TrashFolderRestoredItemStatusField>(itemStatus.getValue(), itemStatus);
      return this;
    }
