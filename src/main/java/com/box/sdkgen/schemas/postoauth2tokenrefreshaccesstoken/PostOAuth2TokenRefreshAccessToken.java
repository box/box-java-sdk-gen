...
public class PostOAuth2TokenRefreshAccessToken {
  ...
  public PostOAuth2TokenRefreshAccessToken(@JsonProperty("client_id") String clientId, @JsonProperty("client_secret") String clientSecret, @JsonProperty("refresh_token") String refreshToken) {
    this.clientId = clientId;
    this.clientSecret = clientSecret;
    this.refreshToken = refreshToken;
    this.grantType = new EnumWrapper<PostOAuth2TokenRefreshAccessTokenGrantTypeField>(PostOAuth2TokenRefreshAccessTokenGrantTypeField.REFRESH_TOKEN.getValue(), PostOAuth2TokenRefreshAccessTokenGrantTypeField.REFRESH_TOKEN);
  }
  ...
  public String toString() {
    return "PostOAuth2TokenRefreshAccessToken{" + "grantType='" + grantType + '\'' + ", " + "clientId='" + clientId + '\'' + ", " + "clientSecret='" + clientSecret + '\'' + ", " + "refreshToken='" + refreshToken + '\'' + "}";
  }
  ...
  public static class PostOAuth2TokenRefreshAccessTokenBuilder {
    ...
    public PostOAuth2TokenRefreshAccessTokenBuilder(String clientId, String clientSecret, String refreshToken) {
      this.clientId = clientId;
      this.clientSecret = clientSecret;
      this.refreshToken = refreshToken;
      this.grantType = new EnumWrapper<PostOAuth2TokenRefreshAccessTokenGrantTypeField>(PostOAuth2TokenRefreshAccessTokenGrantTypeField.REFRESH_TOKEN.getValue(), PostOAuth2TokenRefreshAccessTokenGrantTypeField.REFRESH_TOKEN);
    ...
    public PostOAuth2TokenRefreshAccessTokenBuilder grantType(PostOAuth2TokenRefreshAccessTokenGrantTypeField grantType) {
      this.grantType = new EnumWrapper<PostOAuth2TokenRefreshAccessTokenGrantTypeField>(grantType.getValue(), grantType);
      return this;
    }
