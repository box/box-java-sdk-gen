...
public class ShieldListsCreateV2025R0 extends SerializableObject {
  ...
  protected ShieldListsCreateV2025R0(ShieldListsCreateV2025R0Builder builder) {
    super();
  ...
  public static class ShieldListsCreateV2025R0Builder {
    ...
    public ShieldListsCreateV2025R0Builder(String name, ShieldListContentRequestV2025R0 content) {
      this.name = name;
      this.content = content;
    }

    public ShieldListsCreateV2025R0Builder description(String description) {
