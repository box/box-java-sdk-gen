...
public class AiExtractStructuredFieldsField {
  ...
  public int hashCode() {
    return Objects.hash(
      key, description, displayName, prompt, type, options
    );
  }

  @Override
  public String toString() {
    return "AiExtractStructuredFieldsField{" + "key='" + key + '\'' + ", " + "description='" + description + '\'' + ", " + "displayName='" + displayName + '\'' + ", " + "prompt='" + prompt + '\'' + ", " + "type='" + type + '\'' + ", " + "options='" + options + '\'' + "}";
  }
  ...
  public static class AiExtractStructuredFieldsFieldBuilder {
    ...
    public AiExtractStructuredFieldsFieldBuilder options(List<AiExtractStructuredFieldsOptionsField> options) {
