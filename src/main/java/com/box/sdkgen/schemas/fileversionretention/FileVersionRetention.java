...
public class FileVersionRetention {
  ...
  public String toString() {
    return "FileVersionRetention{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "fileVersion='" + fileVersion + '\'' + ", " + "file='" + file + '\'' + ", " + "appliedAt='" + appliedAt + '\'' + ", " + "dispositionAt='" + dispositionAt + '\'' + ", " + "winningRetentionPolicy='" + winningRetentionPolicy + '\'' + "}";
  }
  ...
  public static class FileVersionRetentionBuilder {
    ...
    public FileVersionRetentionBuilder winningRetentionPolicy(RetentionPolicyMini winningRetentionPolicy) {
