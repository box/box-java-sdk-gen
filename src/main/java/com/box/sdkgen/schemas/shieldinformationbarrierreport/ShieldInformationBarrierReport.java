...
public class ShieldInformationBarrierReport extends ShieldInformationBarrierReportBase {
  ...
  public String toString() {
    return "ShieldInformationBarrierReport{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + ", " + "shieldInformationBarrier='" + shieldInformationBarrier + '\'' + ", " + "status='" + status + '\'' + ", " + "details='" + details + '\'' + ", " + "createdAt='" + createdAt + '\'' + ", " + "createdBy='" + createdBy + '\'' + ", " + "updatedAt='" + updatedAt + '\'' + "}";
  }

  public static class ShieldInformationBarrierReportBuilder extends ShieldInformationBarrierReportBaseBuilder {
    ...
    public ShieldInformationBarrierReportBuilder shieldInformationBarrier(ShieldInformationBarrierReference shieldInformationBarrier) {
      this.shieldInformationBarrier = shieldInformationBarrier;
      return this;
    }

    public ShieldInformationBarrierReportBuilder status(ShieldInformationBarrierReportStatusField status) {
      this.status = new EnumWrapper<ShieldInformationBarrierReportStatusField>(status.getValue(), status);
      return this;
    }

    public ShieldInformationBarrierReportBuilder details(ShieldInformationBarrierReportDetails details) {
    ...
    @Override
    public ShieldInformationBarrierReportBuilder type(ShieldInformationBarrierReportBaseTypeField type) {
      this.type = new EnumWrapper<ShieldInformationBarrierReportBaseTypeField>(type.getValue(), type);
      return this;
    }
