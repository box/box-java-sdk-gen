...
@JsonDeserialize(using = FileFullOrFolderMiniOrWebLink.FileFullOrFolderMiniOrWebLinkDeserializer.class)
...
public class FileFullOrFolderMiniOrWebLink extends OneOfThree<FileFull, FolderMini, WebLink> {
  ...
  static class FileFullOrFolderMiniOrWebLinkDeserializer extends JsonDeserializer<FileFullOrFolderMiniOrWebLink> {
    ...
    @Override
    public FileFullOrFolderMiniOrWebLink deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
      ...
      if(!(discriminant0 == null)){
        switch (discriminant0.asText()) {
          ...
          case "folder":
            return new FileFullOrFolderMiniOrWebLink(JsonManager.deserialize(node, FolderMini.class));
          case "web_link":
