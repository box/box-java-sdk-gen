...
@JsonDeserialize(using = AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser.AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUserDeserializer.class)
...
public class AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser extends OneOfSix<AppItemEventSource, EventSource, File, Folder, Map<String, String>, User> {
  ...
  static class AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUserDeserializer extends JsonDeserializer<AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser> {
    ...
    @Override
    public AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
      JsonNode node = JsonManager.jsonToSerializedData(jp);
      JsonNode discriminant0 = node.get("type");
      if(!(discriminant0 == null)){
        switch (discriminant0.asText()) {
          case "app_item":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, AppItemEventSource.class));
          case "file":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, File.class));
          case "folder":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, Folder.class));
          case "user":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, User.class));
        }
      }
      ...
      if(!(discriminant1 == null)){
        switch (discriminant1.asText()) {
          case "file":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, EventSource.class));
          case "folder":
            return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(JsonManager.deserialize(node, EventSource.class));
        }
      }
      try {
        return new AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(OneOfSix.OBJECT_MAPPER.convertValue(node, Map.class));
      } catch (Exception ignored) {
      }
      throw new JsonMappingException(jp, "Unable to deserialize AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser");
    }
