...
public class ShieldInformationBarrierReportBase {
  ...
  public String toString() {
    return "ShieldInformationBarrierReportBase{" + "id='" + id + '\'' + ", " + "type='" + type + '\'' + "}";
  }
  ...
  public static class ShieldInformationBarrierReportBaseBuilder {
    ...
    public ShieldInformationBarrierReportBaseBuilder type(ShieldInformationBarrierReportBaseTypeField type) {
