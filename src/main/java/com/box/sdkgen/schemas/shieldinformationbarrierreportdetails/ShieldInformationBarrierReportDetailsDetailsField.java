...
public class ShieldInformationBarrierReportDetailsDetailsField {
  ...
  protected ShieldInformationBarrierReportDetailsDetailsField(ShieldInformationBarrierReportDetailsDetailsFieldBuilder builder) {
  ...
  public boolean equals(Object o) {
    ...
    ShieldInformationBarrierReportDetailsDetailsField casted = (ShieldInformationBarrierReportDetailsDetailsField) o;
  ...
  public String toString() {
    return "ShieldInformationBarrierReportDetailsDetailsField{" + "folderId='" + folderId + '\'' + "}";
  }
