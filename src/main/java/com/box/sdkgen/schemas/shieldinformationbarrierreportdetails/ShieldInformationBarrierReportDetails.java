...
public class ShieldInformationBarrierReportDetails {
  ...
  protected ShieldInformationBarrierReportDetails(ShieldInformationBarrierReportDetailsBuilder builder) {
  ...
  public static class ShieldInformationBarrierReportDetailsBuilder {
    ...
    public ShieldInformationBarrierReportDetailsBuilder details(ShieldInformationBarrierReportDetailsDetailsField details) {
